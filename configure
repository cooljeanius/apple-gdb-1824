...
# Generated by GNU Autoconf 2.72 for apple-gdb 1824.
#
...
then :
  ...
  if test ${ZSH_VERSION+y} ; then
    ...
    printf "%s\n" "$0: Please tell bug-autoconf@gnu.org and jmolenda@apple.com
...
PACKAGE_NAME='apple-gdb'
PACKAGE_TARNAME='apple-gdb'
PACKAGE_VERSION='1824'
PACKAGE_STRING='apple-gdb 1824'
PACKAGE_BUGREPORT='jmolenda@apple.com'
PACKAGE_URL=''

ac_unique_file="template.h"
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
'configure' configures apple-gdb 1824 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/apple-gdb]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of apple-gdb 1824:";;
   esac
  cat <<\_ACEOF
...
Optional Features:
  ...
  --disable-opts-test     Do not try to run a test AutoOpts program (only
                          relevant in src subdir)
...
It was created by apple-gdb $as_me 1824, which was
...
ac_aux_files="config.rpath compile ar-lib missing install-sh config.guess config.sub"
...
if test -x "`which sw_vers 2>&5`"; then
  ...
  mac_vers_minor="$(sw_vers -productVersion | cut -d\. -f2 2>&5)"
  if test -n "${mac_vers_major}"; then
    if test ${mac_vers_major} -ge 12; then
      { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: support for Monterey and later still needs to be written" >&5
printf "%s\n" "$as_me: WARNING: support for Monterey and later still needs to be written" >&2;}
      if test -e ./.profile_generic; then
        { printf "%s\n" "$as_me:${as_lineno-$LINENO}: falling back to ./.profile_generic" >&5
printf "%s\n" "$as_me: falling back to ./.profile_generic" >&6;}
        . ./.profile_generic
      else
        { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: you will have to find out what to do here yourself." >&5
printf "%s\n" "$as_me: WARNING: you will have to find out what to do here yourself." >&2;}
      fi
    elif test ${mac_vers_major} -eq 11; then
      if test -e ./.profile_big_sur; then
        { printf "%s\n" "$as_me:${as_lineno-$LINENO}: sourcing ./.profile_big_sur" >&5
printf "%s\n" "$as_me: sourcing ./.profile_big_sur" >&6;}
        . ./.profile_big_sur
      else
        { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Big Sur but missing file for Big Sur)." >&5
printf "%s\n" "$as_me: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Big Sur but missing file for Big Sur)." >&2;}
      fi
      ...
      if test -n "${mac_vers_minor}"; then
        if test ${mac_vers_minor} -eq 15; then
          if test -e ./.profile_catalina; then
            { printf "%s\n" "$as_me:${as_lineno-$LINENO}: sourcing ./.profile_catalina" >&5
printf "%s\n" "$as_me: sourcing ./.profile_catalina" >&6;}
            . ./.profile_catalina
          else
            { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Catalina but missing file for Catalina)." >&5
printf "%s\n" "$as_me: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Catalina but missing file for Catalina)." >&2;}
          fi
        elif test ${mac_vers_minor} -eq 6; then
          if test -e ./.profile_snowleopard; then
            { printf "%s\n" "$as_me:${as_lineno-$LINENO}: sourcing ./.profile_snowleopard" >&5
printf "%s\n" "$as_me: sourcing ./.profile_snowleopard" >&6;}
            . ./.profile_snowleopard
          else
            { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Snow Leopard but missing file for Snow Leopard)." >&5
printf "%s\n" "$as_me: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Snow Leopard but missing file for Snow Leopard)." >&2;}
          fi
        elif test ${mac_vers_minor} -eq 5; then
          if test -e ./.profile_leopard; then
            { printf "%s\n" "$as_me:${as_lineno-$LINENO}: sourcing ./.profile_leopard" >&5
printf "%s\n" "$as_me: sourcing ./.profile_leopard" >&6;}
            . ./.profile_leopard
          else
            { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Leopard but missing file for Leopard)." >&5
printf "%s\n" "$as_me: WARNING: there are some environment variables that you will have to set manually for this to work properly (on Leopard but missing file for Leopard)." >&2;}
          fi
        else
          { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: you will have to find out what to do for this platform yourself (version info: ${mac_vers_major}.${mac_vers_minor})." >&5
printf "%s\n" "$as_me: WARNING: you will have to find out what to do for this platform yourself (version info: ${mac_vers_major}.${mac_vers_minor})." >&2;}
        fi
      else
        { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: you will have to find out what to do for this platform yourself (major vers is 10)." >&5
printf "%s\n" "$as_me: WARNING: you will have to find out what to do for this platform yourself (major vers is 10)." >&2;}
      fi
    else
      { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: you will have to find out what to do for this platform yourself (version info: ${mac_vers_major})." >&5
printf "%s\n" "$as_me: WARNING: you will have to find out what to do for this platform yourself (version info: ${mac_vers_major})." >&2;}
    fi
  else
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: you will have to find out what to do for this platform yourself." >&5
printf "%s\n" "$as_me: WARNING: you will have to find out what to do for this platform yourself." >&2;}
  fi
else
  if test -e ./.profile_generic; then
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: sourcing ./.profile_generic" >&5
...
# Check whether --enable-opts-test was given.
if test ${enable_opts_test+y}
then :
  enableval=$enable_opts_test;
fi

# Checks for programs.
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking programs" >&5
printf %s "checking programs... " >&6; }
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result:  " >&5
printf "%s\n" " " >&6; }
...
if test "x${AWK}" = "x" && test "x${ac_cv_prog_AWK}" = "x"
then :
...
then :
  LIBS="$LEXLIB"
        ac_fn_c_check_func "$LINENO" "yywrap" "ac_cv_func_yywrap"
if test "x$ac_cv_func_yywrap" = xyes
then :
  :
else case e in #(
...
then :
  ...
  LEXLIB="$LIBS"
        ...
        if test x"$ac_cv_search_yywrap" = xno
then :
...
if test "x${ac_cv_prog_make_make_set}" = "x"
then :
...
then :
  ...
  e)     # Double quotes because $OBJC needs to be expanded
...
then :
  ...
  e) ac_save_objcxx_werror_flag=$ac_objcxx_werror_flag
...
then :
  ...
  e) ac_objcxx_werror_flag=$ac_save_objcxx_werror_flag
	 OBJCXXFLAGS="-g"
	 cat confdefs.h - <<_ACEOF >conftest.$ac_ext
/* end confdefs.h.  */
...
then :
  ...
  e)     # Double quotes because $OBJCXX needs to be expanded
...
# Extract the first word of "buildit", so it can be a program name with args.
set dummy buildit; ac_word=$2
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
printf %s "checking for $ac_word... " >&6; }
if test ${ac_cv_path_BUILDIT+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) case $BUILDIT in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_BUILDIT="$BUILDIT" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  case $as_dir in #(((
    ...
    *) as_dir=$as_dir/ ;;
    ...
    for ac_exec_ext in '' $ac_executable_extensions; do
  if as_fn_executable_p "$as_dir$ac_word$ac_exec_ext"; then
    ac_cv_path_BUILDIT="$as_dir$ac_word$ac_exec_ext"
    printf "%s\n" "$as_me:${as_lineno-$LINENO}: found $as_dir$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
BUILDIT=$ac_cv_path_BUILDIT
if test -n "$BUILDIT"; then
  { printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $BUILDIT" >&5
printf "%s\n" "$BUILDIT" >&6; }
else
  { printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: no" >&5
printf "%s\n" "no" >&6; }
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking libraries" >&5
printf %s "checking libraries... " >&6; }
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result:  " >&5
printf "%s\n" " " >&6; }
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for linker flag to verify linked libraries have the correct architecture" >&5
printf %s "checking for linker flag to verify linked libraries have the correct architecture... " >&6; }
...
if test "x${LD_ARCHFLAGS}" != "x"; then
  test -n "${LD_ARCHFLAGS}"
  { printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: ${LD_ARCHFLAGS}" >&5
printf "%s\n" "${LD_ARCHFLAGS}" >&6; }
...
printf %s "checking for printf in -lc... " >&6; }
if test ${ac_cv_lib_c_printf+y}
then :
  printf %s "(cached) " >&6
else case e in #(
...
if test "x$ac_cv_lib_c_printf" = xyes
then :
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for gmp_version in -lgmp" >&5
printf %s "checking for gmp_version in -lgmp... " >&6; }
if test ${ac_cv_lib_gmp_gmp_version+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
then :
  ...
  e) ac_cv_lib_gmp_gmp_version=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_gmp_gmp_version" >&5
printf "%s\n" "$ac_cv_lib_gmp_gmp_version" >&6; }
if test "x$ac_cv_lib_gmp_gmp_version" = xyes
then :
...
then :
  ...
  LDFLAGS="${LDFLAGS} ${LD_ARCHFLAGS}"
  { printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for main in -liberty" >&5
printf %s "checking for main in -liberty... " >&6; }
if test ${ac_cv_lib_iberty_main+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_iberty_main" >&5
printf "%s\n" "$ac_cv_lib_iberty_main" >&6; }
if test "x$ac_cv_lib_iberty_main" = xyes
then :
  printf "%s\n" "#define HAVE_LIBIBERTY 1" >>confdefs.h
...
printf %s "checking for iconv in -liconv... " >&6; }
if test ${ac_cv_lib_iconv_iconv+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
if test "x$ac_cv_lib_iconv_iconv" = xyes
then :
...
printf %s "checking for libiconv in -liconv... " >&6; }
if test ${ac_cv_lib_iconv_libiconv+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
if test "x$ac_cv_lib_iconv_libiconv" = xyes
then :
  printf "%s\n" "#define HAVE_LIBICONV 1" >>confdefs.h
  ...
  e)
    ...
    LDFLAGS="${LDFLAGS} ${LD_ARCHFLAGS}"
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for main in -liconv" >&5
printf %s "checking for main in -liconv... " >&6; }
if test ${ac_cv_lib_iconv_main+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_iconv_main" >&5
printf "%s\n" "$ac_cv_lib_iconv_main" >&6; }
if test "x$ac_cv_lib_iconv_main" = xyes
then :
  printf "%s\n" "#define HAVE_LIBICONV 1" >>confdefs.h
...
then :
  ...
  ## might want to pick a better symbol to check for:
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for mpfr_get_version in -lmpfr" >&5
printf %s "checking for mpfr_get_version in -lmpfr... " >&6; }
if test ${ac_cv_lib_mpfr_mpfr_get_version+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
then :
  ...
  e) ac_cv_lib_mpfr_mpfr_get_version=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_mpfr_mpfr_get_version" >&5
printf "%s\n" "$ac_cv_lib_mpfr_mpfr_get_version" >&6; }
if test "x$ac_cv_lib_mpfr_mpfr_get_version" = xyes
then :
  printf "%s\n" "#define HAVE_LIBMPFR 1" >>confdefs.h
  ...
  LDFLAGS="${LDFLAGS} ${LD_ARCHFLAGS}"
  { printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for main in -lmpfr" >&5
printf %s "checking for main in -lmpfr... " >&6; }
if test ${ac_cv_lib_mpfr_main+y}
then :
  printf %s "(cached) " >&6
else case e in #(
  e) ac_check_lib_save_LIBS=$LIBS
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_mpfr_main" >&5
printf "%s\n" "$ac_cv_lib_mpfr_main" >&6; }
if test "x$ac_cv_lib_mpfr_main" = xyes
then :
  printf "%s\n" "#define HAVE_LIBMPFR 1" >>confdefs.h
...
then :
  ...
  e) ac_cv_lib_readline_rl_initialize=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
then :
  ...
  e) ac_cv_lib_sqlite3_sqlite3_initialize=no ;;
esac
fi
rm -f core conftest.err conftest.$ac_objext conftest.beam \
    conftest$ac_exeext conftest.$ac_ext
...
ac_fn_c_check_header_compile "$LINENO" "gettext.h" "ac_cv_header_gettext_h" "$ac_includes_default"
if test "x$ac_cv_header_gettext_h" = xyes
then :
  printf "%s\n" "#define HAVE_GETTEXT_H 1" >>confdefs.h
...
ac_fn_c_check_header_compile "$LINENO" "libgettext.h" "ac_cv_header_libgettext_h" "$ac_includes_default"
if test "x$ac_cv_header_libgettext_h" = xyes
then :
  printf "%s\n" "#define HAVE_LIBGETTEXT_H 1" >>confdefs.h
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking C compiler charactersistics" >&5
printf %s "checking C compiler charactersistics... " >&6; }
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: result:  " >&5
printf "%s\n" " " >&6; }
...
printf "%s\n" "$ac_cv_type_signal" >&6; }  ## corresponding define:
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for obstacks" >&5
printf %s "checking for obstacks... " >&6; }
...
# Output:
ac_config_files="$ac_config_files libcheckpoint/Makefile"
...
ac_log="
This file was extended by apple-gdb $as_me 1824, which was
generated by GNU Autoconf 2.72.  Invocation command line was
...
do
  case $ac_config_target in
    ...
    "libcheckpoint/Makefile") CONFIG_FILES="$CONFIG_FILES libcheckpoint/Makefile" ;;
