...
#  warning cat-compat.c expects "config.h" to be included.
...
#else
# if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#  warning "cat-compat.c expects <stdio.h> to be included."
# endif /* __GNUC__ && !__STRICT_ANSI__ */
#endif /* HAVE_STDIO_H */
...
#if defined STDC_HEADERS || (defined HAVE_STDLIB_H && defined HAVE_STRING_H)
# include <stdlib.h>
# include <string.h>
#else
...
#else
# if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#  warning "cat-compat.c expects <nl_types.h> to be included."
# endif /* __GNUC__ && !__STRICT_ANSI__ */
...
/* Get ID for given string. If not found, then return -1: */
...
char *textdomain(const char *domainname)
{
  ...
  if (new_catalog == (nl_catd)-1) {
      /* NLSPATH search did NOT work, try absolute path: */
