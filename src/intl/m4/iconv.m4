# iconv.m4 serial 19 (gettext-0.19.2)
...
[
  ...
  dnl# AC_LINK_IFELSE will then fail, the second AC_LINK_IFELSE will
  dnl# succeed.
...
changequote([,])dnl
  ...
  if test "$am_cv_lib_iconv" = yes; then
    ...
    dnl# If $LIBICONV did NOT lead to a usable library, we do NOT need
    dnl# $INCICONV either.
