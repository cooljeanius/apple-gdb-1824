...
#if (defined(__STDC__) && __STDC__) || defined(HAVE_STDDEF_H)
# include <stddef.h> /* Get size_t. */
#endif /* __STDC__ || HAVE_STDDEF_H */
...
#if !defined(HAVE_BUILTIN_EXPECT) && !defined(__builtin_expect)
# define __builtin_expect(expr, val) (expr)
#endif /* !HAVE_BUILTIN_EXPECT && !__builtin_expect */
...
struct loaded_domain
{
  ...
  const char *data;
  /* 1 if the memory is mmap()ed, or 0 if the memory is malloc()ed: */
  int use_mmap;
 ...
 * does NOT allow zero sized arrays: */
#ifndef ZERO
...
#ifndef _LIBC
const char *_nl_locale_name PARAMS((int category,
...
# ifndef _INTL_REDIRECT_MACROS
#  define _INTL_REDIRECT_MACROS 1
# endif /* !_INTL_REDIRECT_MACROS */
# include "libgnuintl.h"
/* (libintl_dcigettext is now defined in libgnuintl.h itself) */
#endif /* _LIBC */
