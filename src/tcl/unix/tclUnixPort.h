...
# else
#  if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#   warning "Not including <sys/param.h>"
#  endif /* __GNUC__ && !__STRICT_ANSI__ */
...
EXTERN Tcl_WideUInt	strtoull _ANSI_ARGS_((CONST char *string,
					      char **endPtr, int base));
# endif /* !HAVE_STRTOLL && TCL_WIDE_INT_TYPE && !TCL_WIDE_INT_IS_LONG */
...
# else
#  if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#   warning "Not including <sys/select.h>"
#  endif /* __GNUC__ && !__STRICT_ANSI__ */
...
#  else
#   if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#    warning "Not including a time-related header."
#   endif /* __GNUC__ && !__STRICT_ANSI__ */
...
# else
#  if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#   warning "Not including <sys/wait.h>"
#  endif /* __GNUC__ && !__STRICT_ANSI__ */
# endif /* !NO_SYS_WAIT_H */
# ifdef HAVE_UNISTD_H
#  include <unistd.h>
...
# else
#  if defined(__GNUC__) && !defined(__STRICT_ANSI__)
#   warning "Not including <sys/utsname.h>"
#  endif /* __GNUC__ && !__STRICT_ANSI__ */
# endif /* !NO_UNAME */
...
/*
 * NeXT does NOT define O_NONBLOCK, so #define it here if necessary.
 */
...
/* we can assume a proper prototype for C99+ though: */
