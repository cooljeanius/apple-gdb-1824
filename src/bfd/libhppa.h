...
/* Using the unused attribute here can actually provoke more new warnings
 * (from -Wused-but-marked-unused) than it silences, so be careful: */
...
static inline int hppa_rebuild_insn (int, int, int);
