...
static bfd_boolean elf64_ia64_relax_section
  PARAMS((bfd *abfd, asection *sec, struct bfd_link_info *link_info,
	  bfd_boolean *again));
static void elf64_ia64_relax_ldxmov
  PARAMS((bfd_byte *contents, bfd_vma off));
static bfd_boolean is_unwind_section_name
  PARAMS ((bfd *abfd, const char *));
static bfd_boolean elf64_ia64_section_flags
  PARAMS ((flagword *, const Elf_Internal_Shdr *));
static bfd_boolean elf64_ia64_fake_sections
  PARAMS ((bfd *abfd, Elf_Internal_Shdr *hdr, asection *sec));
static void elf64_ia64_final_write_processing
  PARAMS ((bfd *abfd, bfd_boolean linker));
static bfd_boolean elf64_ia64_add_symbol_hook
  PARAMS ((bfd *abfd, struct bfd_link_info *info, Elf_Internal_Sym *sym,
	   const char **namep, flagword *flagsp, asection **secp,
	   bfd_vma *valp));
static int elf64_ia64_additional_program_headers
  PARAMS ((bfd *abfd));
static bfd_boolean elf64_ia64_modify_segment_map
  PARAMS ((bfd *, struct bfd_link_info *));
static bfd_boolean elf64_ia64_is_local_label_name
...
static struct bfd_hash_entry *elf64_ia64_new_elf_hash_entry
  PARAMS ((struct bfd_hash_entry *entry, struct bfd_hash_table *table,
	   const char *string));
static void elf64_ia64_hash_copy_indirect
  PARAMS ((const struct elf_backend_data *, struct elf_link_hash_entry *,
	   struct elf_link_hash_entry *));
static void elf64_ia64_hash_hide_symbol
  PARAMS ((struct bfd_link_info *, struct elf_link_hash_entry *, bfd_boolean));
static hashval_t elf64_ia64_local_htab_hash PARAMS ((const void *));
static int elf64_ia64_local_htab_eq PARAMS ((const void *ptr1,
					     const void *ptr2));
static struct bfd_link_hash_table *elf64_ia64_hash_table_create
  PARAMS ((bfd *abfd));
static void elf64_ia64_hash_table_free
  PARAMS ((struct bfd_link_hash_table *hash));
static bfd_boolean elf64_ia64_global_dyn_sym_thunk
  PARAMS ((struct bfd_hash_entry *, PTR));
static int elf64_ia64_local_dyn_sym_thunk
  PARAMS ((void **, PTR));
static void elf64_ia64_dyn_sym_traverse
  PARAMS ((struct elf64_ia64_link_hash_table *ia64_info,
	   ...
	   PTR info));
static bfd_boolean elf64_ia64_create_dynamic_sections
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static struct elf64_ia64_local_hash_entry * get_local_sym_hash
  PARAMS ((struct elf64_ia64_link_hash_table *ia64_info,
...
static bfd_boolean elf64_ia64_check_relocs
  PARAMS ((bfd *abfd, struct bfd_link_info *info, asection *sec,
	   const Elf_Internal_Rela *relocs));
static bfd_boolean elf64_ia64_adjust_dynamic_symbol
...
static bfd_boolean allocate_dynrel_entries
  PARAMS ((struct elf64_ia64_dyn_sym_info *dyn_i, PTR data));
static bfd_boolean elf64_ia64_size_dynamic_sections
...
static bfd_vma elf64_ia64_tprel_base
  PARAMS ((struct bfd_link_info *info));
static bfd_vma elf64_ia64_dtprel_base
  PARAMS ((struct bfd_link_info *info));
static int elf64_ia64_unwind_entry_compare
  PARAMS ((const PTR, const PTR));
static bfd_boolean elf64_ia64_choose_gp
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static bfd_boolean elf64_ia64_final_link
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static bfd_boolean elf64_ia64_relocate_section
  PARAMS ((bfd *output_bfd, struct bfd_link_info *info, bfd *input_bfd,
	   asection *input_section, bfd_byte *contents,
	   Elf_Internal_Rela *relocs, Elf_Internal_Sym *local_syms,
	   asection **local_sections));
static bfd_boolean elf64_ia64_finish_dynamic_symbol
  PARAMS ((bfd *output_bfd, struct bfd_link_info *info,
	   struct elf_link_hash_entry *h, Elf_Internal_Sym *sym));
static bfd_boolean elf64_ia64_finish_dynamic_sections
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static bfd_boolean elf64_ia64_set_private_flags
  PARAMS ((bfd *abfd, flagword flags));
static bfd_boolean elf64_ia64_merge_private_bfd_data
  PARAMS ((bfd *ibfd, bfd *obfd));
static bfd_boolean elf64_ia64_print_private_bfd_data
  PARAMS ((bfd *abfd, PTR ptr));
static enum elf_reloc_type_class elf64_ia64_reloc_type_class
  PARAMS ((const Elf_Internal_Rela *));
static bfd_boolean elf64_ia64_hpux_vec
  PARAMS ((const bfd_target *vec));
static void elf64_hpux_post_process_headers
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
bfd_boolean elf64_hpux_backend_section_from_bfd_section
...
#define IA64_HOWTO(TYPE, NAME, SIZE, PCREL, IN)			\
  HOWTO (TYPE, 0, SIZE, 0, PCREL, 0, complain_overflow_signed,	\
	 elf64_ia64_reloc, NAME, FALSE, 0, -1, IN)
...
{
  bfd_reloc->howto
    = lookup_howto ((unsigned int) ELF64_R_TYPE (elf_reloc->r_info));
}

...
static bfd_boolean
elf64_ia64_relax_br (bfd_byte *contents, bfd_vma off)
{
...
static void
elf64_ia64_relax_brl (bfd_byte *contents, bfd_vma off)
{
  int template;
  bfd_byte *hit_addr;
  ...
  *again = FALSE;
  ...
  for (irel = internal_relocs; irel < irelend; irel++)
      ...
      if (is_branch)
	{
	  ...
	  if ((bfd_signed_vma) (symaddr - reladdr) >= -0x1000000
		...
		{
		  elf64_ia64_relax_brl (contents, roff);
	    ...
	    continue;
	  else if (elf64_ia64_relax_br (contents, roff))
	    {
	      irel->r_info
		= ELF64_R_INFO (ELF64_R_SYM (irel->r_info),
				R_IA64_PCREL60B);
	  ...
	  if (elf64_ia64_install_value (contents + roff, offset, r_type)
	      != bfd_reloc_ok)
	    goto error_return;
      ...
      else
	{
	  ...
	  if (gp == 0)
	    {
	      ...
	      if (gp == 0)
		{
		  if (!elf64_ia64_choose_gp (obfd, link_info))
		    goto error_return;
		  gp = _bfd_get_gp_value (obfd);
		}
	    }
	  ...
	  if (r_type == R_IA64_LTOFF22X)
	    ...
	    {
	      elf64_ia64_relax_ldxmov (contents, roff);
	      irel->r_info = ELF64_R_INFO (0, R_IA64_NONE);
	      changed_contents = TRUE;
	      changed_relocs = TRUE;
	    }
  ...
  if (changed_got)
	  ...
	  && ia64_info->rel_got_sec != NULL)
	{
	  ...
	  if (link_info->shared
	      && ia64_info->self_dtpmod_offset != (bfd_vma) -1)
	    ia64_info->rel_got_sec->size += sizeof (Elf64_External_Rela);
	  data.only_got = TRUE;
...
static void
elf64_ia64_relax_ldxmov (contents, off)
     bfd_byte *contents;
     bfd_vma off;
{
  int shift, r1, r3;
...
static void
elf64_ia64_final_write_processing (abfd, linker)
     bfd *abfd;
...
static bfd_boolean
elf64_ia64_modify_segment_map (abfd, info)
     bfd *abfd;
...
static bfd_boolean
elf64_ia64_dynamic_symbol_p (h, info, r_type)
     struct elf_link_hash_entry *h;
     struct bfd_link_info *info;
     int r_type;
{
...
static void
elf64_ia64_hash_copy_indirect (bed, xdir, xind)
...
static void
elf64_ia64_hash_hide_symbol (info, xh, force_local)
     struct bfd_link_info *info;
...
static hashval_t
elf64_ia64_local_htab_hash (ptr)
     const void *ptr;
{
...
static int
elf64_ia64_local_htab_eq (ptr1, ptr2)
...
static void
elf64_ia64_hash_table_free (hash)
...
{
  bfd_boolean (*func) PARAMS ((struct elf64_ia64_dyn_sym_info *, PTR));
  PTR data;
};
...
static bfd_boolean
elf64_ia64_local_dyn_sym_thunk (slot, xdata)
     void **slot;
     PTR xdata;
{
  struct elf64_ia64_local_hash_entry *entry
     ...
     bfd_boolean create;
{
  ...
  hashval_t h = (((sec->id & 0xff) << 24) | ((sec->id & 0xff00) << 8))
		^ ELF64_R_SYM (rel->r_info) ^ (sec->id >> 16);
  void **slot;
...
static bfd_reloc_status_type
elf64_ia64_install_value (hit_addr, v, r_type)
     bfd_byte *hit_addr;
     bfd_vma v;
     unsigned int r_type;
{
...
static bfd_boolean
elf64_ia64_choose_gp (abfd, info)
     bfd *abfd;
     struct bfd_link_info *info;
{
  ...
  if (!info->relocatable)
    {
	 ...
	 need to adjust gp for it.  */
      ...
      if (! elf64_ia64_choose_gp (abfd, info))
	return FALSE;
     ...
     asection **local_sections;
{
  ...
  for (; rel < relend; ++rel)
	...
	case R_IA64_LTV64MSB:
	case R_IA64_LTV64LSB:
	  r = elf64_ia64_install_value (hit_addr, value, r_type);
	  break;
	...
	case R_IA64_IPLTLSB:
	  ...
	  elf64_ia64_install_value (hit_addr, value, r_type);
	  r = elf64_ia64_install_value (hit_addr + 8, gp_val, r_type);
	  break;
  ...
  if (dyn_i && dyn_i->want_plt)
    {
      ...
      elf64_ia64_install_value (loc, index, R_IA64_IMM22);
      elf64_ia64_install_value (loc+2, -dyn_i->plt_offset, R_IA64_PCREL21B);
      ...
      if (dyn_i->want_plt2)
	{
	  ...
	  elf64_ia64_install_value (loc, pltoff_addr - gp_val, R_IA64_IMM22);
     ...
     struct bfd_link_info *info;
{
  ...
  if (elf_hash_table (info)->dynamic_sections_created)
      ...
      if (ia64_info->plt_sec)
	{
	  ...
	  elf64_ia64_install_value (loc+1, pltres, R_IA64_GPREL22);
	}
    }
...
elf64_ia64_reloc_type_class (rela)
...
elf64_ia64_hpux_vec (const bfd_target *vec)
{
  ...
  return (vec == & bfd_elf64_ia64_hpux_big_vec);
}

static void
elf64_hpux_post_process_headers (abfd, info)
	bfd *abfd;
	struct bfd_link_info *info ATTRIBUTE_UNUSED;
{
...
bfd_boolean
elf64_hpux_backend_section_from_bfd_section (abfd, sec, retval)
	bfd *abfd ATTRIBUTE_UNUSED;
	asection *sec;
	int *retval;
{
...
#define TARGET_BIG_SYM                  bfd_elf64_ia64_hpux_big_vec
