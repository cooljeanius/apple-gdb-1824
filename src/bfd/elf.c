...
#   warning elf.c expects "config.h" to be included.
#  endif /* __GNUC__ && !__STRICT_ANSI__ */
# endif /* HAVE_CONFIG_H */
#else
# ifndef CONFIG_H_PROBABLY_ALREADY_INCLUDED
#  define CONFIG_H_PROBABLY_ALREADY_INCLUDED 1
# endif /* !CONFIG_H_PROBABLY_ALREADY_INCLUDED */
#endif /* !__CONFIG_H__ */
...
void
_bfd_elf_swap_verdef_in(bfd *abfd, const Elf_External_Verdef *src,
                        Elf_Internal_Verdef *dst)
{
  dst->vd_version = (unsigned short)H_GET_16(abfd, src->vd_version);
  dst->vd_flags = (unsigned short)H_GET_16(abfd, src->vd_flags);
  dst->vd_ndx = (unsigned short)H_GET_16(abfd, src->vd_ndx);
  dst->vd_cnt = (unsigned short)H_GET_16(abfd, src->vd_cnt);
...
void
_bfd_elf_swap_verdef_out(bfd *abfd, const Elf_Internal_Verdef *src,
...
void
_bfd_elf_swap_verneed_in(bfd *abfd, const Elf_External_Verneed *src,
			 Elf_Internal_Verneed *dst)
{
  dst->vn_version = (unsigned short)H_GET_16(abfd, src->vn_version);
  dst->vn_cnt = (unsigned short)H_GET_16(abfd, src->vn_cnt);
...
void
_bfd_elf_swap_verneed_out(bfd *abfd, const Elf_Internal_Verneed *src,
...
void
_bfd_elf_swap_vernaux_in(bfd *abfd, const Elf_External_Vernaux *src,
			 Elf_Internal_Vernaux *dst)
{
  dst->vna_hash = H_GET_32(abfd, src->vna_hash);
  dst->vna_flags = (unsigned short)H_GET_16(abfd, src->vna_flags);
  dst->vna_other = (unsigned short)H_GET_16(abfd, src->vna_other);
...
void
_bfd_elf_swap_vernaux_out(bfd *abfd, const Elf_Internal_Vernaux *src,
...
void
_bfd_elf_swap_versym_in(bfd *abfd, const Elf_External_Versym *src,
                        Elf_Internal_Versym *dst)
{
  dst->vs_vers = (unsigned short)H_GET_16(abfd, src->vs_vers);
}

/* Swap out a Versym structure.  */

void
_bfd_elf_swap_versym_out(bfd *abfd, const Elf_Internal_Versym *src,
...
bfd_elf_get_elf_syms(bfd *ibfd, Elf_Internal_Shdr *symtab_hdr,
		     ...
		     Elf_Internal_Sym *intsym_buf, void *extsym_buf,
		     Elf_External_Sym_Shndx *extshndx_buf)
{
  ...
  pos = (symtab_hdr->sh_offset + (file_ptr)(symoffset * extsym_size));
  if (extsym_buf == NULL)
    {
  ...
  if ((shndx_hdr == NULL) || (shndx_hdr->sh_size == 0))
  ...
  else
    {
      ...
      pos = (shndx_hdr->sh_offset
             + (file_ptr)(symoffset * sizeof(Elf_External_Sym_Shndx)));
  ...
  for (esym = (const bfd_byte *)extsym_buf, isym = intsym_buf, shndx = extshndx_buf;
       isym < isymend;
...
const char *
bfd_elf_sym_name(bfd *abfd, Elf_Internal_Shdr *symtab_hdr,
		 Elf_Internal_Sym *isym, asection *sym_sec)
{
  const char *name;
  unsigned long iname = isym->st_name;
  unsigned long shindex = symtab_hdr->sh_link;
...
/* Return the name of the group signature symbol. Why is the
   signature not just a string?  */
...
group_signature(bfd *abfd, Elf_Internal_Shdr *ghdr)
{
  ...
  if ((hdr->sh_type != SHT_SYMTAB)
      || !bfd_section_from_shdr(abfd, (unsigned int)ghdr->sh_link))
    return NULL;
...
{
  unsigned int num_group = (unsigned int)elf_tdata(abfd)->num_group;
  ...
  if (num_group == 0)
      ...
      if (num_group == 0)
	{
	  ...
	  elf_tdata(abfd)->num_group = (int)num_group;
	}
      else
	{
	  ...
	  elf_tdata(abfd)->group_sect_ptr =
	    (Elf_Internal_Shdr **)bfd_alloc2(abfd, num_group,
	  ...
	  for (i = 0; i < shnum; i++)
	      ...
	      if ((shdr->sh_type == SHT_GROUP) && (shdr->sh_size >= 8))
		{
		  ...
		  amt = (shdr->sh_size * sizeof(*dest) / 4UL);
		  shdr->contents = (unsigned char *)bfd_alloc2(abfd,
                                                               shdr->sh_size,
                                                               (sizeof(*dest)
                                                                / 4UL));
		  ...
		  while (1)
		    {
		      ...
		      src -= 4;
		      --dest;
		      idx = (unsigned int)H_GET_32(abfd, src);
  ...
  if (num_group != (unsigned int)-1)
      ...
      for (i = 0; i < num_group; i++)
	{
	  ...
	  unsigned long n_elt = (shdr->sh_size / 4UL);
...
_bfd_elf_setup_group_pointers(bfd *abfd)
{
  ...
  for (i = 0; i < num_group; i++)
	...
	if ((++idx)->shdr->bfd_section)
	  ...
	  /* We will NOT include relocation sections in section groups in
	...
	else
	  {
	    ...
	    (*_bfd_error_handler)
	      (_("%B: unknown [%d] section `%s' in group [%s]"),
	       abfd, (unsigned int)idx->shdr->sh_type,
	       bfd_elf_string_from_elf_section(abfd,
                                               (elf_elfheader(abfd)
                                                ->e_shstrndx),
                                               idx->shdr->sh_name),
...
bfd_boolean
_bfd_elf_make_section_from_shdr(bfd *abfd, Elf_Internal_Shdr *hdr,
                                const char *name, int shindex)
{
  ...
  if ((hdr->sh_flags & SHF_MERGE) != 0)
    {
      flags |= SEC_MERGE;
      newsect->entsize = (unsigned int)hdr->sh_entsize;
	  ...
	  for (i = 0; i < elf_elfheader (abfd)->e_phnum; i++, phdr++)
	    {
		  ...
		  && (((bfd_size_type)hdr->sh_offset + hdr->sh_size)
			  ...
			  <= (phdr->p_offset + phdr->p_filesz))))
		{
		  if ((flags & SEC_LOAD) == 0)
		    ...
		    /* We used to use the same adjustment for SEC_LOAD
		       sections, but that does NOT work if the segment
		    ...
		    newsect->lma = (phdr->p_paddr
				    + (bfd_vma)hdr->sh_offset
                                    - phdr->p_offset);

		  /* With contiguous segments, we cannot tell from file
...
/* ELF relocs are against symbols. If we are producing relocatable
   ...
   be against the same symbol. In such a case, we do NOT want to
  ...
  if (s != NULL)
      ...
      for (; extdyn < extdynend; extdyn += extdynsize)
	{
	  ...
	  if (!stringp)
	    ...
	    {
	      const char *string;
	      unsigned long tagv = dyn.d_un.d_val;
...
void
bfd_elf_print_symbol(bfd *abfd, void *filep, asymbol *symbol,
                     bfd_print_symbol_type how)
{
  ...
  switch (how)
	...
	/* Print the "other" value for a symbol.  For common symbols,
	   we have already printed the size; now print the alignment.
	   For other symbols, we have no specified alignment, and
	   we have printed the address; now print the size.  */
	...
	if ((elf_tdata(abfd)->dynversym_section != 0)
		...
		|| (elf_tdata(abfd)->dynverref_section != 0)))
	  {
		...
		for (i = (int)(10UL - strlen(version_string)); i > 0; --i)
		  putc(' ', file);
	      }
	  }

	/* If the st_other field is not zero, then print it: */
...
bfd_elf_get_dyn_lib_class(bfd *abfd)
{
  ...
  if ((bfd_get_flavour(abfd) == bfd_target_elf_flavour)
      && (bfd_get_format(abfd) == bfd_object))
    lib_class = (int)elf_dyn_lib_class(abfd);
  else
    lib_class = 0;
  return lib_class;
}
...
bfd_elf_set_dyn_lib_class(bfd *abfd, int lib_class)
{
  if ((bfd_get_flavour(abfd) == bfd_target_elf_flavour)
      && (bfd_get_format(abfd) == bfd_object))
    elf_dyn_lib_class(abfd) = (enum dynamic_lib_link_class)lib_class;
}
...
bfd_section_from_shdr (bfd *abfd, unsigned int shindex)
{
  ...
  switch (hdr->sh_type)
    ...
    case SHT_GNU_LIBLIST:	/* .gnu.liblist section.  */
      return _bfd_elf_make_section_from_shdr(abfd, hdr, name, (int)shindex);

    case SHT_DYNAMIC:	/* Dynamic linking information.  */
      if (!_bfd_elf_make_section_from_shdr(abfd, hdr, name, (int)shindex))
	return FALSE;
	...
	return FALSE;
       ...
       * cannot read symbols without that section loaded as well. It
	...
	dynsymtab_strtab:
      ...
      /* If the string table is NOT one of the above, then treat it as a
	...
	/* For some incomprehensible reason Oracle distributes
	   ...
	   to it. I hope this does NOT break anything.  */
	if ((elf_elfsections(abfd)[hdr->sh_link]->sh_type != SHT_SYMTAB)
	    && (elf_elfsections(abfd)[hdr->sh_link]->sh_type != SHT_DYNSYM))
	  {
	    ...
	    if (found != 0)
	      hdr->sh_link = (unsigned long)found;
	  }

	/* Get the symbol table.  */
	if (((elf_elfsections(abfd)[hdr->sh_link]->sh_type == SHT_SYMTAB)
	     || (elf_elfsections(abfd)[hdr->sh_link]->sh_type == SHT_DYNSYM))
	    && !bfd_section_from_shdr(abfd, (unsigned int)hdr->sh_link))
	  return FALSE;

	/* If this reloc section does not use the main symbol table we
	   do NOT treat it as a reloc section. BFD cannot adequately
	   represent such a section, so at least for now, we do NOT
	...
	if (!bfd_section_from_shdr(abfd, (unsigned int)hdr->sh_info)) {
	  return FALSE;
	}
	target_sect = bfd_section_from_elf_index(abfd,
                                                 (unsigned int)hdr->sh_info);
	if (target_sect == NULL) {
	  return FALSE;
	}
	...
	*hdr2 = *hdr;
	...
	target_sect->reloc_count += (unsigned int)NUM_SHDR_ENTRIES(hdr);
    ...
    case SHT_GROUP:
       ...
       * and it is handy to have the signature available as the section
       * name.  */
      ...
      if (hdr->contents != NULL)
	{
	  ...
	  unsigned long n_elt = (hdr->sh_size / 4UL);
	  asection *s;
    ...
    default:
      ...
      return bed->elf_backend_section_from_shdr(abfd, hdr, name, (int)shindex);
    }
...
asection *
bfd_section_from_r_symndx(bfd *abfd, struct sym_sec_cache *cache,
...
/* Given an ELF section number, retrieve the corresponding BFD
   section.  */
asection *
bfd_section_from_elf_index(bfd *abfd, unsigned int uindex)
{
  if (uindex >= elf_numsections(abfd))
    return NULL;
  return elf_elfsections(abfd)[uindex]->bfd_section;
}
                             ...
                             unsigned int rela)
{
  ...
  for (i = 0; spec[i].prefix != NULL; i++)
    {
      size_t suffix_len;
      size_t prefix_len = (size_t)spec[i].prefix_length;
	...
	continue;
      ...
      suffix_len = (size_t)spec[i].suffix_length;
      if (suffix_len <= 0UL)
	{
...
_bfd_elf_get_sec_type_attr(bfd *abfd, asection *sec)
{
  ...
  if (spec)
    {
      spec = _bfd_elf_get_special_section(sec->name, bed->special_sections,
					  sec->use_rela_p);
      if (spec != NULL)
	return spec;
    }
...
_bfd_elf_new_section_hook(bfd *abfd, asection *sec)
{
  ...
  /* When we read a file, we do NOT need section type and flags unless
  ...
  if ((abfd->direction != read_direction)
      || ((sec->flags & SEC_LINKER_CREATED) != 0))
    {
      ...
      if (ssect != NULL)
	{
	  elf_section_type(sec) = (unsigned int)ssect->type;
	  elf_section_flags(sec) = (unsigned int)ssect->attr;
	}
    }
...
/* Create a new bfd section from an ELF program header.
   ...
   into the initialized and uninitialized parts that made it up.
 */
bfd_boolean
_bfd_elf_make_section_from_phdr(bfd *abfd, Elf_Internal_Phdr *hdr,
                                int i_index, const char *thetypename)
{
  asection *newsect;
  char *name;
  char namebuf[64];
  ...
  snprintf(namebuf, sizeof(namebuf), "%s%d%s", thetypename, i_index,
  	   (split ? "a" : ""));
  len = (strlen(namebuf) + (size_t)1UL);
  ...
  newsect->filepos = (file_ptr)hdr->p_offset;
  ...
  if (split)
    {
      snprintf(namebuf, sizeof(namebuf), "%s%db", thetypename, i_index);
...
/* */
bfd_boolean
bfd_section_from_phdr(bfd *abfd, Elf_Internal_Phdr *hdr, int iindex)
{
  const struct elf_backend_data *bed;
  ...
  switch (hdr->p_type)
    {
    case PT_NULL:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "null");

    case PT_LOAD:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "load");

    case PT_DYNAMIC:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "dynamic");

    case PT_INTERP:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "interp");

    case PT_NOTE:
      if (! _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "note"))
	return FALSE;
    ...
    case PT_SHLIB:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "shlib");

    case PT_PHDR:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "phdr");

    case PT_GNU_EH_FRAME:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex,
					     "eh_frame_hdr");

    case PT_GNU_STACK:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "stack");

    case PT_GNU_RELRO:
      return _bfd_elf_make_section_from_phdr(abfd, hdr, iindex, "relro");

    default:
      /* Check for any processor-specific program segment types: */
      bed = get_elf_backend_data(abfd);
      return bed->elf_backend_section_from_phdr(abfd, hdr, iindex, "proc");
    }
}
...
bfd_boolean
_bfd_elf_init_reloc_shdr(bfd *abfd, Elf_Internal_Shdr *rel_hdr,
                         asection *asect, bfd_boolean use_rela_p)
{
  char *name;
  const struct elf_backend_data *bed = get_elf_backend_data(abfd);
  bfd_size_type amt = (sizeof(".rela") + strlen(asect->name) + 1UL);

  name = (char *)bfd_alloc(abfd, amt);
  if (name == NULL)
    return FALSE;
  snprintf(name, amt, "%s%s", (use_rela_p ? ".rela" : ".rel"), asect->name);
  rel_hdr->sh_name =
...
elf_fake_sections(bfd *abfd, asection *asect, void *failedptrarg)
{
  ...
  /* Do NOT clear sh_flags. Assembler may set additional bits.  */
...
bfd_elf_set_group_contents(bfd *abfd, asection *sec, void *failedptrarg)
{
  ...
  if (symindx == 0)
	...
	symindx = (unsigned long)sec->target_index;
    }
  elf_section_data(sec)->this_hdr.sh_info = symindx;

  /* The contents will NOT be allocated for "ld -r" or objcopy: */
  gas = TRUE;
  ...
  while (elt != NULL)
	...
	s = s->output_section;
      idx = 0;
      if (s != NULL)
	idx = (unsigned int)elf_section_data(s)->this_idx;
  ...
  for (l = sec->map_head.link_order; l != NULL; l = l->next)
	...
	loc -= 4;
	H_PUT_32(abfd,
                 (bfd_vma)elf_section_data(elt->output_section)->this_idx,
                 loc);
	elt = elf_next_in_group(elt);
...
/* Assign all ELF section numbers. The dummy first section is handled here
   ...
   in here too, while we are at it.  */
...
assign_section_numbers(bfd *abfd, struct bfd_link_info *link_info)
{
  ...
  Elf_Internal_Shdr **i_shdrp;
  struct bfd_elf_section_data *ddata;
  ...
  if ((link_info == NULL) || link_info->relocatable)
	...
	{
	  ddata = elf_section_data(sec);

	  if (ddata->this_hdr.sh_type == SHT_GROUP)
	    {
	      ...
	      else
		{
		  ...
		  ddata->this_idx = (int)section_number++;
		}
	    }
	}
    }
  ...
  for (sec = abfd->sections; sec; sec = sec->next)
      ...
      if (ddata->this_hdr.sh_type != SHT_GROUP)
	{
      ...
      _bfd_elf_strtab_addref(elf_shstrtab(abfd), ddata->this_hdr.sh_name);
      ...
      else
	{
	  if (section_number == SHN_LORESERVE)
	    section_number += (SHN_HIRESERVE + 1 - SHN_LORESERVE);
	  ddata->rel_idx = (int)section_number++;
	  _bfd_elf_strtab_addref(elf_shstrtab(abfd),
                                 ddata->rel_hdr.sh_name);
	}
      ...
      if (ddata->rel_hdr2)
	{
	  if (section_number == SHN_LORESERVE)
	    section_number += (SHN_HIRESERVE + 1 - SHN_LORESERVE);
	  ddata->rel_idx2 = (int)section_number++;
	  _bfd_elf_strtab_addref(elf_shstrtab(abfd),
                                 ddata->rel_hdr2->sh_name);
	}
      else
	ddata->rel_idx2 = 0;
    }
  ...
  for (sec = abfd->sections; sec; sec = sec->next)
    {
      struct bfd_elf_section_data *edata = elf_section_data(sec);
      asection *s;
      const char *name;

      i_shdrp[edata->this_idx] = &edata->this_hdr;
      if (edata->rel_idx != 0) {
        i_shdrp[edata->rel_idx] = &edata->rel_hdr;
      }
      if (edata->rel_idx2 != 0) {
        i_shdrp[edata->rel_idx2] = edata->rel_hdr2;
      }

      /* Fill in the sh_link and sh_info fields while we are at it.  */
      ...
      if (edata->rel_idx != 0)
	{
	  edata->rel_hdr.sh_link = t->symtab_section;
	  edata->rel_hdr.sh_info = (unsigned long)edata->this_idx;
	}
      if (edata->rel_idx2 != 0)
	{
	  edata->rel_hdr2->sh_link = t->symtab_section;
	  edata->rel_hdr2->sh_info = (unsigned long)edata->this_idx;
	}

      /* We need to set up sh_link for SHF_LINK_ORDER: */
      if ((edata->this_hdr.sh_flags & SHF_LINK_ORDER) != 0)
	{
	  s = elf_linked_to_section(sec);
          if (s) {
            edata->this_hdr.sh_link =
              (unsigned long)elf_section_data(s)->this_idx;
          } else {
            struct bfd_link_order *p;

            /* Find out what the corresponding section in output is: */
            for (p = sec->map_head.link_order; p != NULL; p = p->next)
              {
                s = p->u.indirect.section;
                if ((p->type == bfd_indirect_link_order)
                    && (bfd_get_flavour(s->owner) == bfd_target_elf_flavour))
                  {
                    Elf_Internal_Shdr ** const elf_shdrp =
                      elf_elfsections(s->owner);
                    int elfsec =
                      _bfd_elf_section_from_bfd_section(s->owner, s);
                    elfsec = (int)elf_shdrp[elfsec]->sh_link;
                    /* PR 290:
                     * The Intel C compiler generates SHT_IA_64_UNWIND with
                     * SHF_LINK_ORDER.  But it does NOT set the sh_link or
                        ...
                        if (elf_discarded_section(s))
                          {
                            ...
                            (*_bfd_error_handler)
                              (_("%B: sh_link of section `%A' points to discarded section `%A' of `%B'"),
                               abfd, edata->this_hdr.bfd_section, s,
                               s->owner);
                            /* Point to the kept section if it has the
                             * same size as the discarded one: */
	...
	case SHT_RELA:
	  ...
	  name = sec->name;
	  if (edata->this_hdr.sh_type == SHT_REL)
	    name += 4;
	  else
	    name += 5;
	  s = bfd_get_section_by_name(abfd, name);
	  if (s != NULL)
	    edata->this_hdr.sh_info =
              (unsigned long)elf_section_data(s)->this_idx;
	  break;
	...
	case SHT_STRTAB:
	  ...
	  if ((strncmp(sec->name, ".stab", (sizeof(".stab") - 1UL)) == 0)
		...
		return FALSE;
	      ...
	      if (s != NULL)
		{
		  elf_section_data(s)->this_hdr.sh_link =
                    (unsigned long)edata->this_idx;

		  /* This is a .stab section: */
		  if (elf_section_data(s)->this_hdr.sh_entsize == 0)
		    elf_section_data(s)->this_hdr.sh_entsize =
                      (4UL + ((2UL * (bfd_size_type)bfd_get_arch_size(abfd))
                              / 8UL));
		}
	    }
	  break;
	...
	case SHT_GROUP:
	  edata->this_hdr.sh_link = t->symtab_section;
	  break; /* ...or fallthrough? No real difference... */
        default:
          break;
	}
    }
  ...
  for (secn = 1; secn < section_number; ++secn)
    if (i_shdrp[secn] == NULL)
      ...
      i_shdrp[secn]->sh_name =
      	(unsigned int)_bfd_elf_strtab_offset(elf_shstrtab(abfd),
                                             i_shdrp[secn]->sh_name);
  return TRUE;
}

/* Map symbol from its internal number to the external number, moving
...
elf_map_symbols(bfd *abfd)
{
  ...
  asymbol **sect_syms;
  unsigned int num_locals = 0U;
  unsigned int num_globals = 0U;
  unsigned int num_locals2 = 0U;
  unsigned int num_globals2 = 0U;
  int max_index = 0;
  unsigned int idx;
  asection *asect;
  asymbol **new_syms;
  ...
  max_index++;
  sect_syms = (asymbol **)bfd_zalloc2(abfd, (bfd_size_type)max_index,
                                      sizeof(asymbol *));
  if (sect_syms == NULL) {
    return FALSE;
  }
  ...
  elf_num_locals(abfd) = (int)num_locals;
  elf_num_globals(abfd) = (int)num_globals;
  return TRUE;
}
  ...
  if (align)
    {
      ...
      if (al > 1)
	offset = (unsigned int)BFD_ALIGN(offset, al);
    }
  i_shdrp->sh_offset = offset;
  if (i_shdrp->bfd_section != NULL)
    i_shdrp->bfd_section->filepos = offset;
  if (i_shdrp->sh_type != SHT_NOBITS)
    offset += (file_ptr)i_shdrp->sh_size;
  return offset;
}
...
map_sections_to_segments(bfd *abfd)
{
  ...
  BFD_ASSERT(u_i <= bfd_count_sections(abfd));
  count = u_i;
  ...
  /* Deal with -Ttext or something similar such that the first section
     ...
     approximation, since at this point we do NOT know exactly how many
  ...
  for (u_i = 0U, hdrpp = sections; u_i < count; u_i++, hdrpp++)
    {
      asection *hdr;
      ...
      if (last_hdr == NULL)
	{
	  /* If we do NOT have a segment yet, then we do NOT need a new
	...
	{
	  /* We do NOT want to put a loadable section after a
      ...
      else if ((abfd->flags & D_PAGED) == 0)
	{
	   ...
	   * do NOT require the sections to be correctly aligned in the
	...
	{
	  /* We do NOT want to put a writable section in a read only
      ...
      if (! new_segment)
	{
      ...
      m = make_mapping(abfd, sections, phdr_index, u_i, phdr_in_segment);
      if (m == NULL) {
        goto error_return;
      }
  ...
  /* For each loadable .note section, add a PT_NOTE segment. We do NOT
     use bfd_get_section_by_name, because if we link together
     nonloadable .note sections and loadable .note sections, we will
     generate two .note sections in the output file.
     FIXME: Using names for section types is bogus anyhow.  */
  for (s = abfd->sections; s != NULL; s = s->next)
    {
  ...
  if (tls_count > 0)
    {
      ...
      amt = sizeof(struct elf_segment_map);
      amt += (((size_t)tls_count - 1UL) * sizeof(asection *));
      m = (struct elf_segment_map *)bfd_zalloc(abfd, amt);
      if (m == NULL)
	goto error_return;
      m->next = NULL;
      m->p_type = PT_TLS;
      m->count = (unsigned int)tls_count;
      /* Mandated PF_R: */
      m->p_flags = PF_R;
      m->p_flags_valid = 1;
      for (ii = 0; ii < tls_count; ++ii)
	{
	  BFD_ASSERT(first_tls->flags & SEC_THREAD_LOCAL);
	  m->sections[ii] = first_tls;
...
/* Ian Lance Taylor writes:
   ...
   We should NOT be using % with a negative signed number. That is just
   ...
   What we are trying to say here is something like ``increase OFF by
...
{
  return (file_ptr)((vma - off) % maxpagesize);
}
...
assign_file_positions_for_segments(bfd *abfd, struct bfd_link_info *link_info)
{
  ...
  off += (file_ptr)(alloc * bed->s->sizeof_phdr);
  ...
  for (m = elf_tdata(abfd)->segment_map, p = phdrs;
	  ...
	  && m->count > 0)
	{
	  ...
	  align = ((bfd_size_type)1UL << align_power);

	  if (((abfd->flags & D_PAGED) != 0) && (bed->maxpagesize > align))
	    align = bed->maxpagesize;

	  adjust =
            (bfd_vma)vma_page_aligned_bias(m->sections[0]->vma,
                                           (ufile_ptr)off, align);
	  off += (file_ptr)adjust;
	  if ((adjust != 0) && !m->includes_filehdr && !m->includes_phdrs
	      && ((ufile_ptr)off >= align))
	    {
	      /* If the first section is NOT loadable, the same holds for
               * any other sections. Since the segment will NOT need file
	   ...
	   * PT_DYNAMIC segment.  */
      else if ((p->p_type == PT_DYNAMIC) && (m->count > 1)
	       && (strcmp(m->sections[0]->name, ".dynamic") != 0))
	{
	  _bfd_error_handler
	    (_("%B: The 1st section in the PT_DYNAMIC segment is not the .dynamic section"),
	     abfd);
	  bfd_set_error(bfd_error_bad_value);
	  return FALSE;
	}
      ...
      if (m->includes_phdrs)
	{
	  ...
	  if (m->includes_filehdr)
		...
		{
		  BFD_ASSERT(p->p_type == PT_LOAD);
		  p->p_vaddr -= ((bfd_vma)off - p->p_offset);
		  if (!m->p_paddr_valid)
		    p->p_paddr -= ((bfd_vma)off - p->p_offset);
		}
	  ...
	  || ((p->p_type == PT_NOTE) && (bfd_get_format(abfd) == bfd_core)))
	{
	  if (! m->includes_filehdr && ! m->includes_phdrs)
	    p->p_offset = (bfd_vma)(off + voff);
	  else
	    {
	      file_ptr adjust;

	      adjust = (off - (file_ptr)(p->p_offset + p->p_filesz));
	      p->p_filesz += (bfd_vma)adjust;
	      p->p_memsz += (bfd_vma)adjust;
	    }
	}
      ...
      for (i = 0, secpp = m->sections; i < m->count; i++, secpp++)
	{
	  ...
	  sec = *secpp;
	  flags = sec->flags;
	  align = (1UL << bfd_get_section_alignment(abfd, sec));
	  ...
	  if ((p->p_type == PT_LOAD) || (p->p_type == PT_TLS))
		...
		{
		  adjust =
                    (bfd_signed_vma)(sec->lma - (p->p_paddr + p->p_filesz));
		  if (adjust < 0)
		    {
		      (*_bfd_error_handler)
	      ...
	      /* .tbss is special. It does NOT contribute to p_memsz of
               * normal segments.  */
	  ...
	  if ((p->p_type == PT_NOTE) && (bfd_get_format(abfd) == bfd_core))
		...
		{
		  /* The rest are fake sections that should NOT be written: */
		  sec->filepos = 0;
		  sec->size = 0;
		  sec->flags = 0;
		  continue;
  ...
  for (m = elf_tdata(abfd)->segment_map, p = phdrs;
      ...
      if ((p->p_type != PT_LOAD) && (m->count > 0))
	{
	  ...
	  p->p_offset = (bfd_vma)m->sections[0]->filepos;
	}
      if (m->count == 0)
	{
	  if (m->includes_filehdr)
		  ...
		  && (link_info->relro_end > lp->p_vaddr))
		{
		  ...
		  p->p_align = 1;
		  p->p_flags = (lp->p_flags & (unsigned long)~PF_W);
		}
	      else
		{
		  memset(p, 0, sizeof(*p));
  ...
  if ((bfd_seek(abfd, (bfd_signed_vma)bed->s->sizeof_ehdr, SEEK_SET) != 0)
      || (bed->s->write_out_phdrs(abfd, phdrs, (unsigned int)alloc) != 0)) {
    return FALSE;
  }
...
/* Get the size of the program header.
   ...
   cannot calculate the correct value for a strange memory layout.  This only
...
get_program_header_size(bfd *abfd)
{
  ...
  /* We cannot return a different result each time we are called: */
...
/* Work out the file positions of all the sections. This is called by
   ...
   those that bfd does NOT process as relocations. The latter sort are
   stored in a normal bfd section by bfd_section_from_shdr. We do NOT
   consider the former sort here, unless they form part of the loadable
   image. Reloc sections not assigned here will be handled later by
   assign_file_positions_for_relocs.

   We also do NOT set the positions of the .symtab and .strtab here.  */

static bfd_boolean
assign_file_positions_except_relocs(bfd *abfd, struct bfd_link_info *link_info)
{
  ...
  if (((abfd->flags & (EXEC_P | DYNAMIC)) == 0)
      ...
      for (i = 1, hdrpp = (i_shdrpp + 1); i < num_sec; i++, hdrpp++)
	{
	  ...
	  if ((hdr->bfd_section != NULL)
		...
		abfd, ((hdr->bfd_section == NULL)
                       ? "*unknown*"
                       : hdr->bfd_section->name)));
	      if ((abfd->flags & D_PAGED) != 0)
		off += vma_page_aligned_bias(hdr->sh_addr, (ufile_ptr)off,
					     bed->maxpagesize);
	      else
		off += vma_page_aligned_bias(hdr->sh_addr, (ufile_ptr)off,
					     hdr->sh_addralign);
  ...
  i_ehdrp->e_shoff = (bfd_size_type)off;
...
prep_headers(bfd *abfd)
{
  ...
  switch (bfd_get_arch(abfd))
    ...
    default:
      i_ehdrp->e_machine = (unsigned short)bed->elf_machine_code;
    }
	  ...
	  if (segment2->p_vaddr < segment->p_vaddr)
	    {
	      /* Extend SEGMENT2 to include SEGMENT and then delete
                 SEGMENT.  */
	      extra_length =
		(bfd_signed_vma)(SEGMENT_END(segment, segment->p_vaddr)
		 		 - SEGMENT_END(segment2, segment2->p_vaddr));

	      if (extra_length > 0)
		{
		  segment2->p_memsz += (bfd_vma)extra_length;
		  segment2->p_filesz += (bfd_vma)extra_length;
		}
	  ...
	  else
	    {
	      /* Extend SEGMENT to include SEGMENT2 and then delete
                 SEGMENT2.  */
	      extra_length =
		(bfd_signed_vma)(SEGMENT_END(segment2, segment2->p_vaddr)
				 - SEGMENT_END(segment, segment->p_vaddr));

	      if (extra_length > 0)
		{
		  segment->p_memsz += (bfd_vma)extra_length;
		  segment->p_filesz += (bfd_vma)extra_length;
		}
  ...
  for (i = 0, segment = elf_tdata(ibfd)->phdr;
	...
	if (INCLUDE_SECTION_IN_SEGMENT(section, segment, bed)) {
	 ...
	 all of the sections we have selected.  */
      amt = sizeof(struct elf_segment_map);
      amt += (((bfd_size_type)section_count - 1UL) * sizeof(asection *));
...
swap_out_syms(bfd *abfd, struct bfd_strtab_hash **sttp, int relocatable_p)
{
  ...
  bed = get_elf_backend_data(abfd);
  symcount = (int)bfd_get_symcount(abfd);
  symtab_hdr = &elf_tdata(abfd)->symtab_hdr;
  symtab_hdr->sh_type = SHT_SYMTAB;
  symtab_hdr->sh_entsize = bed->s->sizeof_sym;
  symtab_hdr->sh_size = (symtab_hdr->sh_entsize * ((bfd_size_type)symcount
                                                   + 1UL));
  symtab_hdr->sh_info = ((unsigned long)elf_num_locals(abfd) + 1UL);
  symtab_hdr->sh_addralign = (1 << bed->s->log_file_align);

  symstrtab_hdr = &elf_tdata(abfd)->strtab_hdr;
  symstrtab_hdr->sh_type = SHT_STRTAB;

  outbound_syms = (bfd_byte *)bfd_alloc2(abfd, (1UL + (bfd_size_type)symcount),
                                         bed->s->sizeof_sym);
  ...
  if (symtab_shndx_hdr->sh_name != 0)
    {
      ...
      outbound_shndx = (bfd_byte *)bfd_zalloc2(abfd, (1UL + (size_t)symcount),
                                               sizeof(Elf_External_Sym_Shndx));
  ...
  for (idx = 0; idx < symcount; idx++)
	...
	{
	  sym.st_name = (unsigned long)_bfd_stringtab_add(stt, syms[idx]->name,
                                                          TRUE, FALSE);
	  ...
	  && bfd_is_com_section(syms[idx]->section))
	{
	  ...
	  sym.st_shndx =
            (unsigned int)_bfd_elf_section_from_bfd_section(abfd,
                                                            syms[idx]->section);
	}
      else
	{
	  ...
	  /* Do NOT add in the section vma for relocatable output: */
	  if (! relocatable_p) {
            value += sec->vma;
	  }
	  sym.st_value = value;
	  ...
	  if (bfd_is_abs_section(sec)
	      ...
	      && (type_ptr->internal_elf_sym.st_shndx != 0))
	    {
	      ...
	      shndx = (int)type_ptr->internal_elf_sym.st_shndx;
	      switch (shndx)
		{
		case MAP_ONESYMTAB:
		  shndx = (int)elf_onesymtab(abfd);
		  break;
		case MAP_DYNSYMTAB:
		  shndx = (int)elf_dynsymtab(abfd);
		  break;
		case MAP_STRTAB:
		  shndx = (int)elf_tdata(abfd)->strtab_section;
		  break;
		case MAP_SHSTRTAB:
		  shndx = (int)elf_tdata(abfd)->shstrtab_section;
		  break;
		case MAP_SYM_SHNDX:
		  shndx = (int)elf_tdata(abfd)->symtab_shndx_section;
		  break;
		default:
		  break;
		}
...
Unable to find equivalent output section for symbol '%s' from section '%s'"),
	  ...
	  sym.st_shndx = (unsigned int)shndx;
	}
	...
	sym.st_info =
          (unsigned char)ELF_ST_INFO(((flags & BSF_WEAK)
                                      ? STB_WEAK
                                      : STB_GLOBAL),
                                     type);
      ...
      else
	{
	  ...
	  sym.st_info = (unsigned char)ELF_ST_INFO(bind, type);
	}
...
_bfd_elf_get_symtab_upper_bound(bfd *abfd)
{
  ...
  symcount = (long)(hdr->sh_size
                    / get_elf_backend_data(abfd)->s->sizeof_sym);
  symtab_size = (((size_t)symcount + 1UL) * sizeof(asymbol *));
  if (symcount > 0L)
    symtab_size -= sizeof(asymbol *);

  return (long)symtab_size;
}
...
_bfd_elf_get_dynamic_symtab_upper_bound(bfd *abfd)
{
  ...
  symcount = (long)(hdr->sh_size / get_elf_backend_data(abfd)->s->sizeof_sym);
  symtab_size = (((size_t)symcount + 1UL) * sizeof(asymbol *));
  if (symcount > 0)
    symtab_size -= sizeof(asymbol *);
...
{
  return (long)((asect->reloc_count + 1L) * sizeof(arelent *));
}

/* Canonicalize the relocs: */
long
_bfd_elf_canonicalize_reloc(bfd *abfd, sec_ptr section, arelent **relptr,
			    asymbol **symbols)
{
  arelent *tblptr;
  unsigned int i;
...
_bfd_elf_canonicalize_symtab(bfd *abfd, asymbol **allocation)
{
  ...
  if (symcount >= 0)
    bfd_get_symcount(abfd) = (unsigned int)symcount;
  return symcount;
}
...
_bfd_elf_canonicalize_dynamic_symtab(bfd *abfd, asymbol **allocation)
{
  ...
  if (symcount >= 0)
    bfd_get_dynamic_symcount(abfd) = (unsigned int)symcount;
  return symcount;
}
...
_bfd_elf_get_dynamic_reloc_upper_bound(bfd *abfd)
{
  ...
  for (s = abfd->sections; s != NULL; s = s->next)
	...
	&& (elf_section_data(s)->this_hdr.sh_type == SHT_REL
      ...
      ret += (long)((s->size / elf_section_data(s)->this_hdr.sh_entsize)
                    * sizeof(arelent *));
...
long
_bfd_elf_canonicalize_dynamic_reloc(bfd *abfd, arelent **storage,
				    asymbol **syms)
{
  ...
  for (s = abfd->sections; s != NULL; s = s->next)
	      ...
	      || elf_section_data(s)->this_hdr.sh_type == SHT_RELA))
	{
	  ...
	  if (!(*slurp_relocs)(abfd, s, syms, TRUE))
	    return -1;
	  count = (long)(s->size / elf_section_data(s)->this_hdr.sh_entsize);
	  p = s->relocation;
	  for (i = 0; i < count; i++)
	    *storage++ = p++;
	  ret += count;
...
_bfd_elf_slurp_version_tables(bfd *abfd, bfd_boolean default_imported_symver)
{
  ...
  if (elf_dynverref(abfd) != 0)
	...
	goto error_return;
      ...
      elf_tdata(abfd)->cverrefs = (unsigned int)hdr->sh_info;
...
error_return_verref:
      ...
      for (i = 0; i < hdr->sh_info; i++, iverneed++)
	{
	  ...
	  iverneed->vn_filename =
	    bfd_elf_string_from_elf_section(abfd,
                                            (unsigned int)hdr->sh_link,
					    (unsigned int)iverneed->vn_file);
	  ...
	  for (j = 0; j < iverneed->vn_cnt; j++, ivernaux++)
		...
		bfd_elf_string_from_elf_section(abfd,
                                                (unsigned int)hdr->sh_link,
                                                (unsigned int)ivernaux->vna_name);
...
error_return_verdef:
	  ...
	  for (j = 0; (j < iverdef->vd_cnt) && (iverdaux != NULL); j++, iverdaux++)
		...
		bfd_elf_string_from_elf_section(abfd,
                                                (unsigned int)hdr->sh_link,
                                                (unsigned int)iverdaux->vda_name);
	...
	(Elf_Internal_Verdef *)bfd_zalloc2(abfd, freeidx,
					   sizeof(Elf_Internal_Verdef));
      if (elf_tdata(abfd)->verdef == NULL)
	goto error_return;
  ...
  if (default_imported_symver)
    {
      ...
      iverdef->vd_flags = 0;
      iverdef->vd_ndx = (unsigned short)freeidx;
      iverdef->vd_cnt = 1;
	...
	goto error_return_verdef;
      iverdef->vd_nextdef = NULL;
      iverdef->vd_auxptr =
	(Elf_Internal_Verdaux *)bfd_alloc(abfd, sizeof(Elf_Internal_Verdaux));
      if (iverdef->vd_auxptr == NULL)
	goto error_return_verdef;
		   ...
		   const char **functionname_ptr)
{
  ...
  /* ??? Given multiple file symbols, it is impossible to reliably
     ...
     ld -r does NOT do this. So, for ld -r output, it is possible to
...
{
  return _bfd_dwarf2_find_line(abfd, symbols, symbol, filename_ptr, line_ptr,
                               0, &elf_tdata(abfd)->dwarf2_find_line_info);
}
...
bfd_boolean
_bfd_elf_find_inliner_info(bfd *abfd, const char **filename_ptr,
			   const char **functionname_ptr,
			   unsigned int *line_ptr)
{
  bfd_boolean found;
...
_bfd_elf_sizeof_headers(bfd *abfd, bfd_boolean reloc)
{
  ...
  if (! reloc)
    ret += (int)get_program_header_size(abfd);
  return ret;
}

/* */
bfd_boolean
_bfd_elf_set_section_contents(bfd *abfd, sec_ptr section, const void *location,
...
# ifndef _SYSCALL32
/* the conftest defines this, make sure we stick close to it */
#  define _SYSCALL32
# endif /* !_SYSCALL32 */
# include <sys/procfs.h>
#else
# if defined(__GNUC__) && !defined(__APPLE__)
#  warning elf.c expects <sys/procfs.h> to be included.
# endif /* __GNUC__ && !__APPLE__ */
#endif /* HAVE_SYS_PROCFS_H */

/* FIXME: this is kinda wrong, but it is what gdb wants.  */
...
/* If there is NOT a section called NAME, make one, using
   data from SECT. Note, this function will generate a
   reference to NAME, so you should NOT deallocate or
   overwrite it.  */
                                ...
                                ufile_ptr filepos)
{
  ...
  snprintf(buf, sizeof(buf), "%s/%d", name, elfcore_make_pid(abfd));
  len = (strlen(buf) + 1UL);
...
/* prstatus_t is known to exist on at least the following:
     solaris 2.5+
     linux 2.[01] + glibc
     unixware 4.2
*/
...
/* There is NOT a consistent prfpregset_t across platforms,
   but it does NOT matter, because we do NOT have to pick this
...
#if (defined(HAVE_PRPSINFO_T) && defined prpsinfo_t) || \
    (defined(HAVE_PSINFO_T) && defined psinfo_t)
static bfd_boolean
...
# endif /* HAVE_PSTATUS32_T && pstatus32_t */
  /* Could grab some more details from the "representative"
     lwpstatus_t in pstat.pr_lwp, but we will catch it all in an
...
elfcore_grok_note(bfd *abfd, Elf_Internal_Note *note)
{
  ...
  switch (note->type)
	...
	sect->size = note->descsz;
	sect->filepos = (file_ptr)note->descpos;
	sect->flags = SEC_HAS_CONTENTS;
	sect->alignment_power =
	  (1U + ((unsigned int)bfd_get_arch_size(abfd) / 32U));
...
elfcore_grok_netbsd_procinfo(bfd *abfd, Elf_Internal_Note *note)
{
  ...
  elf_tdata(abfd)->core_signal =
    (int)bfd_h_get_32(abfd, (bfd_byte *)note->descdata + 0x08);

  /* Process ID at offset 0x50: */
  elf_tdata(abfd)->core_pid =
    (int)bfd_h_get_32(abfd, (bfd_byte *)note->descdata + 0x50);
...
elfcore_grok_netbsd_note(bfd *abfd, Elf_Internal_Note *note)
{
  ...
  /* As of Jan 2002 there are no other machine-independent notes
     ...
     than the start of the machine-dependent note types, we do NOT
     understand it.  */
...
elfcore_grok_nto_status(bfd *abfd, Elf_Internal_Note *note, pid_t *tid)
{
  ...
  elf_tdata(abfd)->core_pid = (int)bfd_get_32(abfd, (bfd_byte *)ddata);

  /* nto_procfs_status 'tid' field is at offset 4.  Pass it back: */
  *tid = (pid_t)bfd_get_32(abfd, (bfd_byte *)ddata + 4);

  /* nto_procfs_status 'flags' field is at offset 8: */
  flags = (unsigned int)bfd_get_32(abfd, (bfd_byte *)ddata + 8);

  /* nto_procfs_status 'what' field is at offset 14.  */
  if ((sig = (short)bfd_get_16(abfd, (bfd_byte *)ddata + 14)) > 0)
    {
  ...
  snprintf(buf, sizeof(buf), ".qnx_core_status/%ld", (long)*tid);
  ...
  if (name != NULL)
    {
      ...
      bed = get_elf_backend_data(abfd);
      pad = (-namesz & ((1UL << bed->s->log_file_align) - 1UL));
    }

  newspace = (12UL + namesz + pad + (size_t)size);

  p = (char *)realloc(buf, (*(size_t *)bufsiz + newspace));
  dest = (p + *bufsiz);
  *bufsiz += (int)newspace;
  xnp = (Elf_External_Note *)dest;
  H_PUT_32(abfd, namesz, xnp->namesz);
  H_PUT_32(abfd, (bfd_vma)size, xnp->descsz);
  H_PUT_32(abfd, (bfd_vma)type, xnp->type);
  dest = xnp->name;
  if (name != NULL)
    {
  ...
  while (p < (buf + size))
    {
      ...
      in.descpos = (bfd_vma)(offset + (in.descdata - buf));

      if (strncmp(in.namedata, "NetBSD-CORE", 11UL) == 0)
        {
          if (! elfcore_grok_netbsd_note(abfd, &in)) {
            goto error;
          }
        }
      else if (strncmp(in.namedata, "QNX", 3UL) == 0)
	{
...
bfd_get_elf_phdrs(bfd *abfd, void *phdrs)
{
  ...
  num_phdrs = (int)elf_elfheader(abfd)->e_phnum;
  memcpy(phdrs, elf_tdata(abfd)->phdr,
	 ((size_t)num_phdrs * sizeof(Elf_Internal_Phdr)));
...

long
_bfd_elf_get_synthetic_symtab(bfd *abfd, long symcount ATTRIBUTE_UNUSED,
                              ...
                              asymbol **ret)
{
  ...
  *ret = NULL;
  ...
  count = (long)(relplt->size / hdr->sh_entsize);
  size = ((size_t)count * sizeof(asymbol));
  p = relplt->relocation;
  ...
  for (i = 0; i < count; i++, s++, p++)
    {
      ...
      addr = bed->plt_sym_val((bfd_vma)i, plt, p);
      if (addr == (bfd_vma)-1L) {
        continue;
      }
...
elf_sort_elf_symbol(const void *arg1, const void *arg2)
{
  ...
  shndx = (int)(s1->st_shndx - s2->st_shndx);
  if (shndx != 0) {
    return shndx;
  }
...
/* Check if 2 sections define the same set of local and global symbols: */
bfd_boolean
bfd_elf_match_symbols_in_sections(asection *sec1, asection *sec2)
{
  ...
  /* If both are .gnu.linkonce sections, then they have to have the same
   * section name: */
  ...
  if (((elf_section_flags(sec1) & SHF_GROUP) != 0)
    ...
    {
      /* If both are members of section groups, then they have to have the
       * same group name.  */
  ...
  isymbuf1 = bfd_elf_get_elf_syms(bfd1, hdr1, symcount1, 0, NULL, NULL,
                                  NULL);
  isymbuf2 = bfd_elf_get_elf_syms(bfd2, hdr2, symcount2, 0, NULL, NULL,
                                  NULL);
  ...
  symtable1 = (struct elf_symbol *)bfd_malloc(count1 * sizeof(struct elf_symbol));
  symtable2 = (struct elf_symbol *)bfd_malloc(count1 * sizeof(struct elf_symbol));
...
asection _bfd_elf_large_com_section
  = BFD_FAKE_SECTION(_bfd_elf_large_com_section,
                     SEC_IS_COMMON, NULL, NULL, "LARGE_COMMON", 0);

#ifdef _SYSCALL32
# undef _SYSCALL32
#endif /* _SYSCALL32 */
#ifdef CONFIG_H_PROBABLY_ALREADY_INCLUDED
# undef CONFIG_H_PROBABLY_ALREADY_INCLUDED
#endif /* CONFIG_H_PROBABLY_ALREADY_INCLUDED */
