...
struct elf32_ia64_dyn_sym_info
{
  ...
  struct elf32_ia64_dyn_sym_info *next;
...
#define elf32_ia64_hash_table(p) \
  ((struct elf32_ia64_link_hash_table *) ((p)->hash))

static bfd_reloc_status_type elf32_ia64_reloc
...
static reloc_howto_type *elf32_ia64_reloc_type_lookup
  PARAMS ((bfd *abfd, bfd_reloc_code_real_type bfd_code));
static void elf32_ia64_info_to_howto
  PARAMS ((bfd *abfd, arelent *bfd_reloc, Elf_Internal_Rela *elf_reloc));
static bfd_boolean elf32_ia64_relax_section
  PARAMS((bfd *abfd, asection *sec, struct bfd_link_info *link_info,
	  bfd_boolean *again));
static void elf32_ia64_relax_ldxmov
  PARAMS((bfd_byte *contents, bfd_vma off));
static bfd_boolean is_unwind_section_name
  PARAMS ((bfd *abfd, const char *));
static bfd_boolean elf32_ia64_section_flags
  PARAMS ((flagword *, const Elf_Internal_Shdr *));
static bfd_boolean elf32_ia64_fake_sections
  PARAMS ((bfd *abfd, Elf_Internal_Shdr *hdr, asection *sec));
static void elf32_ia64_final_write_processing
  PARAMS ((bfd *abfd, bfd_boolean linker));
static bfd_boolean elf32_ia64_add_symbol_hook
  PARAMS ((bfd *abfd, struct bfd_link_info *info, Elf_Internal_Sym *sym,
	   const char **namep, flagword *flagsp, asection **secp,
	   bfd_vma *valp));
static int elf32_ia64_additional_program_headers
  PARAMS ((bfd *abfd));
static bfd_boolean elf32_ia64_modify_segment_map
  PARAMS ((bfd *, struct bfd_link_info *));
static bfd_boolean elf32_ia64_is_local_label_name
  PARAMS ((bfd *abfd, const char *name));
static bfd_boolean elf32_ia64_dynamic_symbol_p
  PARAMS ((struct elf_link_hash_entry *h, struct bfd_link_info *info, int));
static struct bfd_hash_entry *elf32_ia64_new_elf_hash_entry
  PARAMS ((struct bfd_hash_entry *entry, struct bfd_hash_table *table,
	   const char *string));
static void elf32_ia64_hash_copy_indirect
  PARAMS ((const struct elf_backend_data *, struct elf_link_hash_entry *,
	   struct elf_link_hash_entry *));
static void elf32_ia64_hash_hide_symbol
  PARAMS ((struct bfd_link_info *, struct elf_link_hash_entry *, bfd_boolean));
static hashval_t elf32_ia64_local_htab_hash PARAMS ((const void *));
static int elf32_ia64_local_htab_eq PARAMS ((const void *ptr1,
					     const void *ptr2));
static struct bfd_link_hash_table *elf32_ia64_hash_table_create
  PARAMS ((bfd *abfd));
static void elf32_ia64_hash_table_free
  PARAMS ((struct bfd_link_hash_table *hash));
static bfd_boolean elf32_ia64_global_dyn_sym_thunk
  PARAMS ((struct bfd_hash_entry *, PTR));
static int elf32_ia64_local_dyn_sym_thunk
  PARAMS ((void **, PTR));
static void elf32_ia64_dyn_sym_traverse
  PARAMS ((struct elf32_ia64_link_hash_table *ia64_info,
	   bfd_boolean (*func) (struct elf32_ia64_dyn_sym_info *, PTR),
	   PTR info));
static bfd_boolean elf32_ia64_create_dynamic_sections
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static struct elf32_ia64_local_hash_entry * get_local_sym_hash
  PARAMS ((struct elf32_ia64_link_hash_table *ia64_info,
...
static asection *get_reloc_section
  PARAMS ((bfd *abfd, struct elf32_ia64_link_hash_table *ia64_info,
	   asection *sec, bfd_boolean create));
static bfd_boolean elf32_ia64_check_relocs
  PARAMS ((bfd *abfd, struct bfd_link_info *info, asection *sec,
	   const Elf_Internal_Rela *relocs));
static bfd_boolean elf32_ia64_adjust_dynamic_symbol
  PARAMS ((struct bfd_link_info *info, struct elf_link_hash_entry *h));
static long global_sym_index
  PARAMS ((struct elf_link_hash_entry *h));
static bfd_boolean allocate_fptr
  PARAMS ((struct elf32_ia64_dyn_sym_info *dyn_i, PTR data));
...
static bfd_boolean allocate_dynrel_entries
  PARAMS ((struct elf32_ia64_dyn_sym_info *dyn_i, PTR data));
static bfd_boolean elf32_ia64_size_dynamic_sections
  PARAMS ((bfd *output_bfd, struct bfd_link_info *info));
static bfd_reloc_status_type elf32_ia64_install_value
  PARAMS ((bfd_byte *hit_addr, bfd_vma val, unsigned int r_type));
static void elf32_ia64_install_dyn_reloc
  PARAMS ((bfd *abfd, struct bfd_link_info *info, asection *sec,
	   asection *srel, bfd_vma offset, unsigned int type,
	   long dynindx, bfd_vma addend));
static bfd_vma set_got_entry
  PARAMS ((bfd *abfd, struct bfd_link_info *info,
	   struct elf32_ia64_dyn_sym_info *dyn_i, long dynindx,
...
static bfd_vma elf32_ia64_tprel_base
  PARAMS ((struct bfd_link_info *info));
static bfd_vma elf32_ia64_dtprel_base
  PARAMS ((struct bfd_link_info *info));
static int elf32_ia64_unwind_entry_compare
  PARAMS ((const PTR, const PTR));
static bfd_boolean elf32_ia64_choose_gp
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static bfd_boolean elf32_ia64_final_link
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static bfd_boolean elf32_ia64_relocate_section
  PARAMS ((bfd *output_bfd, struct bfd_link_info *info, bfd *input_bfd,
	   asection *input_section, bfd_byte *contents,
	   Elf_Internal_Rela *relocs, Elf_Internal_Sym *local_syms,
	   asection **local_sections));
static bfd_boolean elf32_ia64_finish_dynamic_symbol
  PARAMS ((bfd *output_bfd, struct bfd_link_info *info,
	   struct elf_link_hash_entry *h, Elf_Internal_Sym *sym));
static bfd_boolean elf32_ia64_finish_dynamic_sections
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
static bfd_boolean elf32_ia64_set_private_flags
  PARAMS ((bfd *abfd, flagword flags));
static bfd_boolean elf32_ia64_merge_private_bfd_data
  PARAMS ((bfd *ibfd, bfd *obfd));
static bfd_boolean elf32_ia64_print_private_bfd_data
  PARAMS ((bfd *abfd, PTR ptr));
static enum elf_reloc_type_class elf32_ia64_reloc_type_class
  PARAMS ((const Elf_Internal_Rela *));
static bfd_boolean elf32_ia64_hpux_vec
  PARAMS ((const bfd_target *vec));
static void elf32_hpux_post_process_headers
  PARAMS ((bfd *abfd, struct bfd_link_info *info));
bfd_boolean elf32_hpux_backend_section_from_bfd_section
  PARAMS ((bfd *abfd, asection *sec, int *retval));

/* ia64-specific relocation.  */

/* Perform a relocation.  Not much to do here as all the hard work is
   done in elf32_ia64_final_link_relocate.  */
static bfd_reloc_status_type
elf32_ia64_reloc (abfd, reloc, sym, data, input_section,
...
static reloc_howto_type*
elf32_ia64_reloc_type_lookup (abfd, bfd_code)
     bfd *abfd ATTRIBUTE_UNUSED;
...
static void
elf32_ia64_info_to_howto (abfd, bfd_reloc, elf_reloc)
     bfd *abfd ATTRIBUTE_UNUSED;
     arelent *bfd_reloc;
     Elf_Internal_Rela *elf_reloc;
{
  bfd_reloc->howto
    = lookup_howto ((unsigned int) ELF32_R_TYPE (elf_reloc->r_info));
}

...
static bfd_boolean
elf32_ia64_relax_br (bfd_byte *contents, bfd_vma off)
{
...
static void
elf32_ia64_relax_brl (bfd_byte *contents, bfd_vma off)
{
  int template;
  bfd_byte *hit_addr;
...
static bfd_boolean
elf32_ia64_relax_section (abfd, sec, link_info, again)
     bfd *abfd;
     asection *sec;
  ...
  *again = FALSE;
  ...
  for (irel = internal_relocs; irel < irelend; irel++)
      ...
      if (is_branch)
	{
	  ...
	  if ((bfd_signed_vma) (symaddr - reladdr) >= -0x1000000
		...
		{
		  elf32_ia64_relax_brl (contents, roff);
	    ...
	    continue;
	  else if (elf32_ia64_relax_br (contents, roff))
	    {
	      irel->r_info
		= ELF32_R_INFO (ELF32_R_SYM (irel->r_info),
				R_IA64_PCREL60B);
	  ...
	  if (elf32_ia64_install_value (contents + roff, offset, r_type)
	      != bfd_reloc_ok)
	    goto error_return;
      ...
      else
	{
	  ...
	  if (gp == 0)
	    {
	      ...
	      if (gp == 0)
		{
		  if (!elf32_ia64_choose_gp (obfd, link_info))
		    goto error_return;
		  gp = _bfd_get_gp_value (obfd);
		}
	    }
	  ...
	  if (r_type == R_IA64_LTOFF22X)
	    ...
	    {
	      elf32_ia64_relax_ldxmov (contents, roff);
	      irel->r_info = ELF32_R_INFO (0, R_IA64_NONE);
	      changed_contents = TRUE;
	      changed_relocs = TRUE;
	    }
  ...
  if (changed_got)
	  ...
	  && ia64_info->rel_got_sec != NULL)
	{
	  ...
	  if (link_info->shared
	      && ia64_info->self_dtpmod_offset != (bfd_vma) -1)
	    ia64_info->rel_got_sec->size += sizeof (Elf32_External_Rela);
	  data.only_got = TRUE;
...
static void
elf32_ia64_relax_ldxmov (contents, off)
     bfd_byte *contents;
     bfd_vma off;
{
  int shift, r1, r3;
...
static bfd_boolean
elf32_ia64_section_flags (flags, hdr)
     flagword *flags;
...
static bfd_boolean
elf32_ia64_fake_sections (abfd, hdr, sec)
     bfd *abfd ATTRIBUTE_UNUSED;
     Elf_Internal_Shdr *hdr;
     asection *sec;
{
...
static void
elf32_ia64_final_write_processing (abfd, linker)
     bfd *abfd;
...
static bfd_boolean
elf32_ia64_add_symbol_hook (abfd, info, sym, namep, flagsp, secp, valp)
     bfd *abfd;
     struct bfd_link_info *info;
...
static int
elf32_ia64_additional_program_headers (abfd)
     bfd *abfd;
{
  asection *s;
  int ret = 0;
...
static bfd_boolean
elf32_ia64_modify_segment_map (abfd, info)
     bfd *abfd;
...
static bfd_boolean
elf32_ia64_is_local_label_name (abfd, name)
     bfd *abfd ATTRIBUTE_UNUSED;
     const char *name;
{
  return name[0] == '.';
...
static bfd_boolean
elf32_ia64_dynamic_symbol_p (h, info, r_type)
     struct elf_link_hash_entry *h;
     struct bfd_link_info *info;
     int r_type;
{
...
elf32_ia64_new_elf_hash_entry (entry, table, string)
...
static void
elf32_ia64_hash_copy_indirect (bed, xdir, xind)
...
static void
elf32_ia64_hash_hide_symbol (info, xh, force_local)
     struct bfd_link_info *info;
...
static hashval_t
elf32_ia64_local_htab_hash (ptr)
     const void *ptr;
{
...
static int
elf32_ia64_local_htab_eq (ptr1, ptr2)
...
elf32_ia64_hash_table_create (abfd)
     bfd *abfd;
{
...
static void
elf32_ia64_hash_table_free (hash)
     struct bfd_link_hash_table *hash;
{
  struct elf32_ia64_link_hash_table *ia64_info
    = (struct elf32_ia64_link_hash_table *) hash;
...
{
  bfd_boolean (*func) PARAMS ((struct elf32_ia64_dyn_sym_info *, PTR));
  PTR data;
};

static bfd_boolean
elf32_ia64_global_dyn_sym_thunk (xentry, xdata)
     ...
     PTR xdata;
{
  ...
  if (entry->root.root.type == bfd_link_hash_warning)
    entry = (struct elf32_ia64_link_hash_entry *) entry->root.root.u.i.link;
...
static bfd_boolean
elf32_ia64_local_dyn_sym_thunk (slot, xdata)
     void **slot;
     PTR xdata;
{
  struct elf32_ia64_local_hash_entry *entry
...
static void
elf32_ia64_dyn_sym_traverse (ia64_info, func, data)
     struct elf32_ia64_link_hash_table *ia64_info;
     bfd_boolean (*func) PARAMS ((struct elf32_ia64_dyn_sym_info *, PTR));
     PTR data;
{
...

static bfd_boolean
elf32_ia64_create_dynamic_sections (abfd, info)
     bfd *abfd;
     struct bfd_link_info *info;
{
  struct elf32_ia64_link_hash_table *ia64_info;
...
get_dyn_sym_info (ia64_info, h, abfd, rel, create)
     ...
     bfd_boolean create;
{
  struct elf32_ia64_dyn_sym_info **pp;
  struct elf32_ia64_dyn_sym_info *dyn_i;
  bfd_vma addend = rel ? rel->r_addend : 0;

  if (h)
    pp = &((struct elf32_ia64_link_hash_entry *)h)->info;
  else
    {
  ...
  if (dyn_i == NULL && create)
    {
      dyn_i = ((struct elf32_ia64_dyn_sym_info *)
...
static bfd_boolean
elf32_ia64_check_relocs (abfd, info, sec, relocs)
     bfd *abfd;
     struct bfd_link_info *info;
     asection *sec;
     const Elf_Internal_Rela *relocs;
...
static bfd_boolean
elf32_ia64_adjust_dynamic_symbol (info, h)
     struct bfd_link_info *info ATTRIBUTE_UNUSED;
     struct elf_link_hash_entry *h;
{
...
static bfd_boolean
elf32_ia64_size_dynamic_sections (output_bfd, info)
...
static bfd_reloc_status_type
elf32_ia64_install_value (hit_addr, v, r_type)
     bfd_byte *hit_addr;
     bfd_vma v;
     unsigned int r_type;
{
...
static void
elf32_ia64_install_dyn_reloc (abfd, info, sec, srel, offset, type,
			      dynindx, addend)
     bfd *abfd;
     struct bfd_link_info *info;
     asection *sec;
...
static int
elf32_ia64_unwind_entry_compare (a, b)
     const PTR a;
     const PTR b;
{
  bfd_vma av, bv;
...
static bfd_boolean
elf32_ia64_choose_gp (abfd, info)
     bfd *abfd;
     struct bfd_link_info *info;
{
...
static bfd_boolean
elf32_ia64_final_link (abfd, info)
     bfd *abfd;
     struct bfd_link_info *info;
{
  struct elf32_ia64_link_hash_table *ia64_info;
  ...
  if (!info->relocatable)
    {
	 ...
	 need to adjust gp for it.  */
      ...
      if (! elf32_ia64_choose_gp (abfd, info))
	return FALSE;
...
static bfd_boolean
elf32_ia64_relocate_section (output_bfd, info, input_bfd, input_section,
     ...
     asection **local_sections;
{
  ...
  for (; rel < relend; ++rel)
	...
	case R_IA64_LTV64MSB:
	case R_IA64_LTV64LSB:
	  r = elf32_ia64_install_value (hit_addr, value, r_type);
	  break;
	...
	case R_IA64_IPLTLSB:
	  ...
	  elf32_ia64_install_value (hit_addr, value, r_type);
	  r = elf32_ia64_install_value (hit_addr + 8, gp_val, r_type);
	  break;
...
static bfd_boolean
elf32_ia64_finish_dynamic_symbol (output_bfd, info, h, sym)
     bfd *output_bfd;
     struct bfd_link_info *info;
     struct elf_link_hash_entry *h;
     Elf_Internal_Sym *sym;
  ...
  if (dyn_i && dyn_i->want_plt)
    {
      ...
      elf32_ia64_install_value (loc, index, R_IA64_IMM22);
      elf32_ia64_install_value (loc+2, -dyn_i->plt_offset, R_IA64_PCREL21B);
      ...
      if (dyn_i->want_plt2)
	{
	  ...
	  elf32_ia64_install_value (loc, pltoff_addr - gp_val, R_IA64_IMM22);
...
static bfd_boolean
elf32_ia64_finish_dynamic_sections (abfd, info)
     bfd *abfd;
     struct bfd_link_info *info;
{
  struct elf32_ia64_link_hash_table *ia64_info;
  ...
  if (elf_hash_table (info)->dynamic_sections_created)
      ...
      if (ia64_info->plt_sec)
	{
	  ...
	  elf32_ia64_install_value (loc+1, pltres, R_IA64_GPREL22);
	}
    }
...
static bfd_boolean
elf32_ia64_set_private_flags (abfd, flags)
     bfd *abfd;
     flagword flags;
{
...
static bfd_boolean
elf32_ia64_merge_private_bfd_data (ibfd, obfd)
     bfd *ibfd, *obfd;
{
  flagword out_flags;
  flagword in_flags;
...
static bfd_boolean
elf32_ia64_print_private_bfd_data (abfd, ptr)
     bfd *abfd;
     PTR ptr;
{
  FILE *file = (FILE *) ptr;
...
elf32_ia64_reloc_type_class (rela)
...
elf32_ia64_hpux_vec (const bfd_target *vec)
{
  ...
  return (vec == & bfd_elf32_ia64_hpux_big_vec);
}

static void
elf32_hpux_post_process_headers (abfd, info)
	bfd *abfd;
	struct bfd_link_info *info ATTRIBUTE_UNUSED;
{
...
bfd_boolean
elf32_hpux_backend_section_from_bfd_section (abfd, sec, retval)
	bfd *abfd ATTRIBUTE_UNUSED;
	asection *sec;
	int *retval;
{
...

#define TARGET_LITTLE_SYM		bfd_elf32_ia64_little_vec
#define TARGET_LITTLE_NAME		"elf32-ia64-little"
#define TARGET_BIG_SYM			bfd_elf32_ia64_big_vec
...
#define TARGET_BIG_SYM                  bfd_elf32_ia64_hpux_big_vec
