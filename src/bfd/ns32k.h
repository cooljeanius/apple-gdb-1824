...
extern bfd_reloc_status_type _bfd_do_ns32k_reloc_contents(reloc_howto_type *, bfd *, bfd_vma, bfd_byte *,
...
extern bfd_reloc_status_type _bfd_ns32k_reloc_disp(bfd *, arelent *, asymbol *,
						   void *, asection *, bfd *,
						   const char **);
extern bfd_reloc_status_type _bfd_ns32k_reloc_imm(bfd *, arelent *, asymbol *,
						  void *, asection *, bfd *,
						  const char **);
