...
#ifndef elf32_arm_link_hash_traverse
                            ...
                            const char *string)
{
  ...
  if (ret == (struct elf32_arm_link_hash_entry *)NULL)
    ret = (struct elf32_arm_link_hash_entry *)bfd_hash_allocate(table,
			  ...
			  struct elf_link_hash_entry *h)
{
  ...
  /* If we mark it 'Thumb', then the disassembler will do a better job: */
  myh = (struct elf_link_hash_entry *)bh;
                        ...
                        bfd_signed_vma addend, bfd_vma val)
{
  ...
  bfd_put_32(output_bfd,
	     (bfd_vma)insert_thumb_branch(tmp, (int)ret_offset),
			      ...
			      bfd_boolean *unresolved_reloc_p)
{
  ...
  switch (r_type)
	...
	case R_ARM_PREL31:
      ...
      /* That was the end of the inner switch on 'r_type'; we are still
       * inside the outer one though... */
	...
	value = tpoff(info, value);
      ...
      return _bfd_final_link_relocate(howto, input_bfd, input_section, contents, 			      rel->r_offset, value, (bfd_vma)0UL);
...
#if defined(NOT_ACTUALLY_BOGUS) && defined(BFD_ASSERT)
  BFD_ASSERT(elf_flags_init(ibfd));
#endif /* NOT_ACTUALLY_BOGUS && BFD_ASSERT */
...
# undef BACK_FROM_ARM
#endif /* BACK_FROM_ARM */
#ifdef elf32_arm_link_hash_traverse
