/* coff-aux.c: BFD back-end for Apple M68K COFF A/UX 3.x files.
...
static bfd_boolean
coff_m68k_aux_link_add_one_symbol(struct bfd_link_info *info, bfd *abfd,
                                  ...
                                  struct bfd_link_hash_entry **hashp)
{
  ...
  /* If we did NOT exit early, then finish processing in the generic
   * routine: */
