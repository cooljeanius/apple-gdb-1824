/* elf64-target.h is generated from elfxx-target.h */
/* elfxx-target.h: Target definitions for 64-bit ELF
...
#define bfd_elf64_get_section_contents_in_window_with_mode \
