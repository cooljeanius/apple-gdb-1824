/* elfxx-mips.c: MIPS-specific support for ELF
...
#ifndef CRF_MIPS_SHORT
# define CRF_MIPS_SHORT			0
#endif /* !CRF_MIPS_SHORT */
...
#ifndef CRT_MIPS_GPHI_LO
# define CRT_MIPS_GPHI_LO		0xc
#endif /* !CRT_MIPS_GPHI_LO */
#ifdef CRT_MIPS_JMPAD
# define CRT_MIPS_JMPAD			0xd
#endif /* CRT_MIPS_JMPAD */
...
/* Get word-sized data: */
#ifndef MIPS_ELF_GET_WORD
# define MIPS_ELF_GET_WORD(abfd, ptr) \
   (ABI_64_P(abfd) ? bfd_get_64(abfd, ptr) : bfd_get_32(abfd, ptr))
#endif /* !MIPS_ELF_GET_WORD */
...
#define MINUS_ONE	(((bfd_vma)0L) - 1L)
#define MINUS_TWO	(((bfd_vma)0L) - 2L)
...
{
  /* If tls_sec is NULL, then we should have signalled an error already: */
			    ...
			    struct bfd_hash_table *table, const char *string)
{
  ...
  ret = ((struct mips_elf_link_hash_entry *)
	 _bfd_elf_link_hash_newfunc((struct bfd_hash_entry *)ret, table,
                                    string));
  if (ret != NULL)
    {
      /* Set local fields: */
...
#define READ(ptr, offset, count, size, type)				\
  if (symhdr->count == 0)						\
    ...
    {									\
      bfd_size_type amt = 						\
        (bfd_size_type)(size * (__typeof__(size))symhdr->count);	\
...
ecoff_swap_rpdr_out(bfd *abfd, const RPDR *in, struct rpdr_ext *ex)
{
  ...
  H_PUT_32(abfd, (bfd_vma)in->regmask, ex->p_regmask);
  H_PUT_32(abfd, (bfd_vma)in->regoffset, ex->p_regoffset);
  H_PUT_32(abfd, (bfd_vma)in->fregmask, ex->p_fregmask);
  H_PUT_32(abfd, (bfd_vma)in->fregoffset, ex->p_fregoffset);
  H_PUT_32(abfd, (bfd_vma)in->frameoffset, ex->p_frameoffset);

  H_PUT_16(abfd, (bfd_vma)in->framereg, ex->p_framereg);
  H_PUT_16(abfd, (bfd_vma)in->pcreg, ex->p_pcreg);

  H_PUT_32(abfd, (bfd_vma)in->irpss, ex->p_irpss);
}
                                ...
                                struct ecoff_debug_info *debug)
{
  ...
  count = (bfd_size_type)hdr->ipdMax;
  if (count > 0UL)
    {
	...
	goto error_return;
      ...
      count = (bfd_size_type)hdr->isymMax;
	...
	goto error_return;
      ...
      count = (bfd_size_type)hdr->issMax;
      ...
      for (i = 0; i < (unsigned long)count; i++, rp++)
	{
	  ...
	  rp->pcreg = pdr.pcreg;
	  rp->irpss = (long)sindex;
	  sv[i] = (ss + sym.iss);
	  sindex += (strlen(sv[i]) + 1UL);
	}
    }

  size = (sizeof(struct rpdr_ext) * (count + 2UL) + sindex);
  ...
  if ((h->fn_stub != NULL) && ! h->need_fn_stub)
    {
      ...
      h->fn_stub->size = 0;
      h->fn_stub->flags &= (flagword)~SEC_RELOC;
  ...
  if ((h->call_stub != NULL) && (h->root.other == STO_MIPS16))
    {
      ...
      h->call_stub->size = 0;
      h->call_stub->flags &= (flagword)~SEC_RELOC;
  ...
  if ((h->call_fp_stub != NULL) && (h->root.other == STO_MIPS16))
    {
      ...
      h->call_fp_stub->flags &= (flagword)~SEC_RELOC;
			      ...
			      bfd_boolean relocatable, void *data, bfd_vma gp)
{
  ...
  val = (bfd_signed_vma)reloc_entry->addend;

  _bfd_mips_elf_sign_extend((bfd_vma)val, 16);
  ...
  if (reloc_entry->howto->partial_inplace)
    {
      status = _bfd_relocate_contents(reloc_entry->howto, abfd, (bfd_vma)val,
				      ((bfd_byte *)data
                                       + reloc_entry->address));
    ...
    reloc_entry->addend = (bfd_vma)val;
			 ...
			 bfd *output_bfd, const char **error_message)
{
  ...
  _bfd_mips16_elf_reloc_unshuffle(abfd, (int)reloc_entry->howto->type, FALSE,
				  location);
  vallo = bfd_get_32(abfd, location);
  _bfd_mips16_elf_reloc_shuffle(abfd, (int)reloc_entry->howto->type, FALSE,
                                location);
			    ...
			    const char **error_message ATTRIBUTE_UNUSED)
{
  ...
  if (relocatable && !reloc_entry->howto->partial_inplace)
  ...
  else
    {
      ...
      _bfd_mips16_elf_reloc_unshuffle(abfd, (int)reloc_entry->howto->type,
                                      FALSE, location);
      status = _bfd_relocate_contents(reloc_entry->howto, abfd, (bfd_vma)val,
				      location);
      _bfd_mips16_elf_reloc_shuffle(abfd, (int)reloc_entry->howto->type, FALSE,
			  ...
			  Elf32_External_crinfo *ex)
{
  ...
  l = (unsigned long)(((in->ctype & CRINFO_CTYPE) << CRINFO_CTYPE_SH)
                      | ((in->rtype & CRINFO_RTYPE) << CRINFO_RTYPE_SH)
                      | ((in->dist2to & CRINFO_DIST2TO) << CRINFO_DIST2TO_SH)
                      | ((in->relvaddr & CRINFO_RELVADDR)
                         << CRINFO_RELVADDR_SH));
                               ...
                               Elf32_RegInfo *in)
{
  ...
  in->ri_gp_value = (long)H_GET_32(abfd, ex->ri_gp_value);
}
                                ...
                                Elf32_External_RegInfo *ex)
{
  ...
  H_PUT_32(abfd, (bfd_vma)in->ri_gp_value, ex->ri_gp_value);
}
			     ...
			     Elf_Internal_Options *in)
{
  ...
  in->section = (unsigned short)H_GET_16(abfd, ex->section);
...
sort_dynamic_relocs_64(const void *arg1, const void *arg2)
{
  ...
  return (int)(ELF64_R_SYM(int_reloc1[0].r_info)
...
mips_elf_got_entry_hash(const void *entry_)
{
  ...
  return
    ((hashval_t)entry->symndx
     + (hashval_t)((entry->tls_type & GOT_TLS_LDM) << 17U)
     + ((!entry->abfd)
...
mips_elf_count_local_tls_relocs(void **arg1, void *arg2)
{
  ...
  if ((entry->abfd != NULL) && (entry->symndx != -1))
    arg->needed +=
      (unsigned int)mips_tls_got_relocs(arg->info, entry->tls_type, NULL);
...
mips_elf_count_global_tls_relocs(void *arg1, void *arg2)
{
  ...
  arg->needed +=
    (unsigned int)mips_tls_got_relocs(arg->info, hm->tls_type, &hm->root);
...
static void
mips_elf_output_dynamic_relocation(bfd *output_bfd, asection *sreloc,
				   unsigned long indx, int r_type,
				   bfd_vma offset)
{
  ...
  if (*tls_type_p & GOT_TLS_GD)
      ...
      if (need_relocs)
	{
	  mips_elf_output_dynamic_relocation
	    (abfd, sreloc, (unsigned long)indx,
  ...
  if (*tls_type_p & GOT_TLS_LDM)
    {
	 ...
	 bias by DTP_OFFSET.  */
      MIPS_ELF_PUT_WORD(abfd, 0, (sgot->contents + got_offset
			  ...
			  int r_type, struct bfd_link_info *info)
{
      ...
      if ((g->next != gg) || TLS_RELOC_P(r_type))
	{
	  ...
	  if (TLS_RELOC_P(r_type))
		...
		value = (h->root.u.def.value
	      ...
	      return mips_tls_got_index(abfd, (bfd_vma)p->gotidx, &p->tls_type,
         				r_type, info, e.d.h, value);
	    }
	  else
	    return (bfd_vma)p->gotidx;
	}
    }
  ...
  if (TLS_RELOC_P(r_type))
	...
	value = (h->root.u.def.value
      ...
      got_index = mips_tls_got_index(abfd, hm->tls_got_offset,
                                     &hm->tls_type, r_type, info, hm,
                                     value);
    }
  else
    {
	 ...
	 offset.  */
      ...
      got_index = ((bfd_vma)(h->dynindx - global_got_dynindx + g->local_gotno)
                   * MIPS_ELF_GOT_SIZE(abfd));
    }
                               ...
                               bfd *input_bfd, bfd_vma i_index)
{
  ...
  return (sgot->output_section->vma + sgot->output_offset + i_index - gp);
}
...
mips_elf_create_local_got_entry(bfd *abfd, bfd *ibfd, struct mips_got_info *gg,
...
mips_elf_sort_hash_table(struct bfd_link_info *info, unsigned long max_local)
{
  ...
  hsd.max_unref_got_dynindx =
    hsd.min_got_dynindx = (long)(elf_hash_table(info)->dynsymcount
     ...
     * entries that are referenced from getting too large offsets: */
                           	 - (g->next ? g->assigned_gotno : 0L));
  hsd.max_non_got_dynindx = (long)max_local;
...
mips_elf_make_got_per_bfd (void **entryp, void *p)
{
  ...
  if (bfdgot != NULL)
  ...
  else
    {
      bfdgot =
        ((struct mips_elf_bfd2got_hash *)
         bfd_alloc(arg->obfd, sizeof(struct mips_elf_bfd2got_hash)));
      ...
      if (g == NULL)
	{
      ...
      g->global_gotno = 0;
      g->local_gotno = 0;
      g->assigned_gotno = (unsigned int)-1;
      g->tls_gotno = 0;
...
mips_elf_merge_gots(void **bfd2got_, void *p)
{
  ...
  /* If it looks like we can merge this bfd's entries with those of
	   ...
	   && ((arg->primary_count + lcount + gcount + tcount) <= maxcnt))
    {
      ...
      int old_lcount = (int)arg->primary->local_gotno;
      int old_gcount = (int)arg->primary->global_gotno;
      int old_tcount = (int)arg->primary->tls_gotno;
	...
	return 0;
	 ...
	 table anyway.  */
      ...
      BFD_ASSERT(((unsigned int)old_lcount + lcount)
      		 >= arg->primary->local_gotno);
      BFD_ASSERT(((unsigned int)old_gcount + gcount)
      		 >= arg->primary->global_gotno);
      BFD_ASSERT(((unsigned int)old_tcount + tcount)
      		 >= arg->primary->tls_gotno);
  ...
  /* If we can merge with the last-created got, do it.  */
    ...
    {
      struct mips_got_info *g = bfd2got->g;
      int old_lcount = (int)arg->current->local_gotno;
      int old_gcount = (int)arg->current->global_gotno;
      int old_tcount = (int)arg->current->tls_gotno;
	...
	return 0;
      ...
      BFD_ASSERT(((unsigned int)old_lcount + lcount)
                 >= arg->current->local_gotno);
      BFD_ASSERT(((unsigned int)old_gcount + gcount)
                 >= arg->current->global_gotno);
      BFD_ASSERT(((unsigned int)old_tcount + tcount)
                 >= arg->current->tls_gotno);

      arg->current_count = (arg->current->local_gotno
                            + arg->current->global_gotno
                            + arg->current->tls_gotno);
    }
  /* Well, we failed merge, so create a new GOT.  Skip checking if it
...
mips_elf_initialize_tls_index(void **entryp, void *p)
{
  ...
  if (entry->symndx == -1)
	...
	{
	  entry->gotidx = (long)g->tls_ldm_offset;
	  return 1;
	}
    }
  ...
  if (g->next == NULL && entry->symndx == -1)
    entry->d.h->tls_got_offset = (bfd_vma)entry->gotidx;
  ...
  if (entry->tls_type & GOT_TLS_LDM)
    g->tls_ldm_offset = (bfd_vma)entry->gotidx;
...
mips_elf_set_global_got_offset(void **entryp, void *p)
{
  ...
  if (g && (entry->tls_type != GOT_NORMAL))
    arg->needed_relocs +=
      ((unsigned int)
       mips_tls_got_relocs(arg->info, (unsigned char)entry->tls_type,
			   ((entry->symndx == -1)
      			    ? &entry->d.h->root : NULL)));
  ...
  if ((entry->abfd != NULL) && (entry->symndx == -1)
	...
	entry->d.h->root.got.offset = (bfd_vma)arg->value;
    }
			     ...
			     bfd_boolean require_jalx)
{
  ...
  if (bfd_get_mach(input_bfd) == bfd_mach_mips9000
	...
	dest = value;
      off = (bfd_signed_vma)(dest - addr);
      if ((off <= 0x1ffff) && (off >= -0x20000))
	x = (0x04110000 | (((bfd_vma)off >> 2) & 0xffff)); /* bal addr */
    }

  /* Put the value into the output: */
  bfd_put((8U * bfd_get_reloc_size(howto)), input_bfd, x, location);
...

/* Work over a section just before writing it out.  This routine is used by
 * both the 32-bit and the 64-bit ABI.
 * FIXME: We recognize sections that need the SHF_MIPS_GPREL flag by name;
...
_bfd_mips_elf_section_processing(bfd *abfd, Elf_Internal_Shdr *hdr)
{
  if (hdr->sh_type == SHT_MIPS_REGINFO
      && (hdr->sh_size > 0))
    {
      ...
      if (bfd_seek(abfd,
		   (hdr->sh_offset
                    + (file_ptr)sizeof(Elf32_External_RegInfo) - 4L),
		   SEEK_SET) != 0)
	return FALSE;
	  ...
	  if (ABI_64_P(abfd) && intopt.kind == ODK_REGINFO)
	    {
	      ...
	      if (bfd_seek(abfd,
			   (hdr->sh_offset
			    + (l - contents)
			    + (file_ptr)sizeof(Elf_External_Options)
			    + ((file_ptr)sizeof(Elf64_External_RegInfo) - 8L)),
			    SEEK_SET) != 0)
		return FALSE;
				 ...
				 int shindex)
{
  ...
  if (hdr->sh_type == SHT_MIPS_REGINFO)
	...
	return FALSE;
      ...
      elf_gp(abfd) = (bfd_vma)s.ri_gp_value;
    }
	  ...
	  if (ABI_64_P(abfd) && intopt.kind == ODK_REGINFO)
		...
		(abfd,
		 ((Elf32_External_RegInfo *)
		  (l + sizeof(Elf_External_Options))),
		 &intreg);
	      elf_gp(abfd) = (bfd_vma)intreg.ri_gp_value;
	    }
	  l += intopt.size;
	}
      free(contents);
			      ...
			      asection **secp, bfd_vma *valp)
{
  ...
  switch (sym->st_shndx)
      ...
      if (elf_tdata(abfd)->elf_data_section == NULL)
	{
      ...
      /* This code used to do *secp = bfd_und_section_ptr if
         info->shared.  I do NOT know why, and that does NOT make sense,
         so I took it out.  */
			    ...
			    asection *sec, const Elf_Internal_Rela *relocs)
{
  ...
  for (rel = relocs; rel < rel_end; ++rel)
		 ...
		 || r_type == R_MIPS_GOT_DISP))
	{
	  ...
	  if (!mips_elf_record_local_got_symbol(abfd, (long)r_symndx,
                                                rel->r_addend, g, 0))
	    return FALSE;
	}
  ...
  *again = FALSE;
  ...
  for (irel = internal_relocs; irel < irelend; irel++)
      ...
      else
	{
	 ...
	 branch target.  */
      sym_offset = (bfd_signed_vma)((symval + irel->r_addend)
                                    - (sec_start + irel->r_offset + 4L));
...
bfd_boolean
_bfd_mips_elf_always_size_sections(bfd *output_bfd, struct bfd_link_info *info)
{
  asection *ri;
  ...
  if (g->global_gotsym != NULL)
    i = (int)(elf_hash_table(info)->dynsymcount
              - (bfd_size_type)g->global_gotsym->dynindx);
  else
  ...
  /* In the worst case, we'll get one stub per dynamic symbol, plus
     ...
     rld.  */
  loadable_size += (bfd_size_type)(MIPS_FUNCTION_STUB_SIZE * (i + 1));
	  ...
	  if (rel_hdr->sh_entsize == MIPS_ELF_REL_SIZE(input_bfd))
	    {
	      ...
	      _bfd_mips16_elf_reloc_unshuffle(input_bfd, (int)r_type, FALSE,
					      location);
	      addend = mips_elf_obtain_contents(howto, rel, input_bfd,
                                                contents);
	      _bfd_mips16_elf_reloc_shuffle(input_bfd, (int)r_type, FALSE,
					    location);
				    ...
				    Elf_Internal_Sym *sym)
{
  ...
  if (h->plt.offset != MINUS_ONE)
	...
	return FALSE;
      ...
      bfd_put_32(output_bfd, (bfd_vma)(STUB_LI16(output_bfd) + h->dynindx),
      		 (stub + 12));
  ...
  if ((g->global_gotsym != NULL)
      && (h->dynindx >= g->global_gotsym->dynindx))
    {
      ...
      value = sym->st_value;
      offset = mips_elf_global_got_index(dynobj, output_bfd, h, R_MIPS_GOT16,
      					 info);
				      ...
				      struct bfd_link_info *info)
{
  ...
  if (elf_hash_table(info)->dynamic_sections_created)
	   ...
	   b += MIPS_ELF_DYN_SIZE(dynobj))
	{
	  ...
	  /* Assume that we are going to modify it and write it out: */
	  swap_out_p = TRUE;
	  ...
	  switch (dyn.d_tag)
	    ...
	    case DT_MIPS_GOTSYM:
	      if (gg->global_gotsym)
		{
		  dyn.d_un.d_val = (bfd_vma)gg->global_gotsym->dynindx;
		  break;
		}
  ...
  /* The first entry of the global offset table will be filled at runtime.
   * The second entry will be used by some runtime loaders.
   * This is NOT the case of IRIX rld.  */
	   ...
	   b += MIPS_ELF_DYN_SIZE(dynobj))
	{
	  ...
	  switch (dyn.d_tag)
	    ...
	    case DT_RELSZ:
		 ...
		 which does NOT seem to apply any relocations if there
	...
	if (s != NULL)
	  {
	    ...
	    cpt.id2 = 2;
	    cpt.offset = ((size_t)s->output_section->filepos
			  + sizeof(Elf32_External_compact_rel));
	    cpt.reserved0 = 0;
	    cpt.reserved1 = 0;
		...
		dummy_offset = (file_ptr)(s->size - MIPS_FUNCTION_STUB_SIZE);
				     ...
				     bfd_boolean linker ATTRIBUTE_UNUSED)
{
  ...
  for (i = 1, hdrpp = (elf_elfsections(abfd) + 1);
	...
	case SHT_MIPS_LIBLIST:
	  ...
	  if (sec != NULL)
	    (*hdrpp)->sh_link = (unsigned long)elf_section_data(sec)->this_idx;
	  break;
	case SHT_MIPS_GPTAB:
	  BFD_ASSERT((*hdrpp)->bfd_section != NULL);
	  name = bfd_get_section_name(abfd, (*hdrpp)->bfd_section);
	  BFD_ASSERT((name != NULL)
		     && (strncmp(name, ".gptab.", (sizeof(".gptab.") - 1UL)) == 0));
	  sec = bfd_get_section_by_name(abfd, name + sizeof(".gptab") - 1);
	  BFD_ASSERT(sec != NULL);
	  (*hdrpp)->sh_info = (unsigned long)elf_section_data(sec)->this_idx;
	  break;
	case SHT_MIPS_CONTENT:
	  BFD_ASSERT((*hdrpp)->bfd_section != NULL);
	  name = bfd_get_section_name(abfd, (*hdrpp)->bfd_section);
	  BFD_ASSERT((name != NULL)
		     && (strncmp(name, ".MIPS.content",
                                 (sizeof(".MIPS.content") - 1UL)) == 0));
	  sec = bfd_get_section_by_name(abfd,
                                        (name + sizeof(".MIPS.content") - 1UL));
	  BFD_ASSERT(sec != NULL);
	  (*hdrpp)->sh_link = (unsigned long)elf_section_data(sec)->this_idx;
	  break;
	case SHT_MIPS_SYMBOL_LIB:
	...
	case SHT_MIPS_EVENTS:
	  ...
	  name = bfd_get_section_name(abfd, (*hdrpp)->bfd_section);
	  BFD_ASSERT(name != NULL);
	  if (strncmp(name, ".MIPS.events", (sizeof(".MIPS.events") - 1UL)) == 0)
	    sec = bfd_get_section_by_name(abfd,
					  (name + sizeof(".MIPS.events") - 1UL));
	  else
	    {
	      BFD_ASSERT(strncmp(name, ".MIPS.post_rel",
                                 (sizeof(".MIPS.post_rel") - 1UL)) == 0);
	      sec = bfd_get_section_by_name(abfd,
					    (name
					     + sizeof(".MIPS.post_rel") - 1UL));
	    }
	  BFD_ASSERT(sec != NULL);
	  (*hdrpp)->sh_link = (unsigned long)elf_section_data(sec)->this_idx;
	  break;
				 ...
				 unsigned int *line_ptr)
{
  ...
  if (msec != NULL)
      ...
      if (fi == NULL)
	{
	  ...
	  amt =
            ((bfd_size_type)fi->d.symbolic_header.ifdMax * sizeof(struct fdr));
	  ...
	  fraw_end = (fraw_src
		      + ((bfd_size_type)fi->d.symbolic_header.ifdMax
                         * external_fdr_size));
...
/* */
bfd_boolean
_bfd_mips_elf_find_inliner_info(bfd *abfd, const char **filename_ptr,
                                const char **functionname_ptr,
                                unsigned int *line_ptr)
{
  bfd_boolean found;
...
bfd_byte *
_bfd_elf_mips_get_relocated_section_contents(bfd *abfd,
                                             struct bfd_link_info *link_info,
...
_bfd_mips_elf_final_link(bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (elf_hash_table(info)->dynamic_sections_created)
      ...
      if (info->shared)
	{
	  ...
	  for (psec = abfd->sections; psec; psec = psec->next)
	    if (((psec->flags & SEC_EXCLUDE) == 0)
		&& ((psec->flags & SEC_ALLOC) != 0)
		&& !(*bed->elf_backend_omit_section_dynsym)(abfd, info,
                                                            psec))
	      ++dynsecsymcount;

          /* scope for 'psec' should be limited to here */
	}

      if (! mips_elf_sort_hash_table(info, dynsecsymcount + 1))
	return FALSE;

      /* Make sure we did NOT grow the global .got region: */
      dynobj = elf_hash_table(info)->dynobj;
      got = mips_elf_got_section(dynobj, FALSE);
      g = mips_elf_section_data(got)->u.got_info;
  ...
  for (o = abfd->sections; o != NULL; o = o->next)
      ...
      if (strcmp(o->name, ".reginfo") == 0)
	{
	  ...
	  for (porder = o->map_head.link_order; porder != NULL;
               porder = porder->next)
	    {
	      asection *input_section;
	      bfd *input_bfd;
	      ...
	      if (porder->type != bfd_indirect_link_order)
		{
		  if (porder->type == bfd_data_link_order)
		    continue;
		  abort();
		}

	      input_section = porder->u.indirect.section;
		...
		return FALSE;
		 ...
		 elf_link_input_bfd ignores this section.  */
	      input_section->flags &= (flagword)~SEC_HAS_CONTENTS;
	    }
      ...
      if (strcmp(o->name, ".mdebug") == 0)
	{
	  ...
	  for (i = 0; i < (sizeof(secname) / sizeof(secname[0])); i++)
	    {
	      esym.asym.sc = (unsigned int)sc[i];
	  ...
	  for (porder = o->map_head.link_order; porder != NULL;
	      ...
	      if (porder->type != bfd_indirect_link_order)
		{
		  ...
		  || (get_elf_backend_data(input_bfd)->elf_backend_ecoff_debug_swap
                      == NULL))
		{
                  /* I do NOT know what a non MIPS ELF bfd would be doing
                   * with a .mdebug section, but I do NOT really want
                   * to deal with it: */
		  continue;
		}

	      input_swap = get_elf_backend_data(input_bfd)->elf_backend_ecoff_debug_swap;

	      BFD_ASSERT(porder->size == input_section->size);
		...
		return FALSE;
		 ...
		 for the output external symbols.  */
	      ...
	      eraw_end = (eraw_src
			  + ((bfd_size_type)input_debug.symbolic_header.iextMax
	  ...
	  /* Skip this section later on (I do NOT think that this currently
	   * matters, but someday it might).  */
	  o->map_head.link_order = NULL;
      ...
      if (strncmp(o->name, ".gptab.", (sizeof(".gptab.") - 1UL)) == 0)
	{
	  const char *subname;
	  unsigned int c;
	  Elf32_gptab *tab;
	  ...
	  if (! info->relocatable)
                   ...
                   porder = porder->next)
		{
	      ...
	      /* Skip this section later on (I do NOT think this
	  ...
	  subname = (o->name + sizeof(".gptab") - 1UL);
		  ...
		  if (! exact)
		    {
		      ...
		      amt = ((bfd_size_type)(c + 1UL)
                             * sizeof(Elf32_gptab));
		      new_tab = (Elf32_gptab *)bfd_realloc(tab, amt);
		      if (new_tab == NULL)
			{
			  free(tab);
			  return FALSE;
...
_bfd_mips_elf_merge_private_bfd_data(bfd *ibfd, bfd *obfd)
{
  ...
  new_flags &= (flagword)~EF_MIPS_NOREORDER;
  old_flags &= (flagword)~EF_MIPS_NOREORDER;

  /* Some IRIX 6 BSD-compatibility objects have this bit set.  It
     doesn't seem to matter.  */
  new_flags &= (flagword)~EF_MIPS_XGOT;
  old_flags &= (flagword)~EF_MIPS_XGOT;

  /* MIPSpro generates ucode info in n64 objects.  Again, we should
     just be able to ignore this.  */
  new_flags &= (flagword)~EF_MIPS_UCODE;
  old_flags &= (flagword)~EF_MIPS_UCODE;
  ...
  for (sec = ibfd->sections; sec != NULL; sec = sec->next)
    {
      ...
      if (strcmp(sec->name, ".reginfo") && strcmp(sec->name, ".mdebug")
	  && ((sec->size != 0)
	      || (strcmp(sec->name, ".text") && strcmp(sec->name, ".data")
		  && strcmp(sec->name, ".bss"))))
	{
  ...
  if (!(new_flags & EF_MIPS_PIC))
    elf_elfheader(obfd)->e_flags &= (flagword)~EF_MIPS_PIC;

  new_flags &= (flagword)~(EF_MIPS_PIC | EF_MIPS_CPIC);
  old_flags &= (flagword)~(EF_MIPS_PIC | EF_MIPS_CPIC);
  ...
  if (mips_32bit_flags_p(old_flags) != mips_32bit_flags_p(new_flags))
    ...
    {
      /* OBFD's ISA is NOT the same as, or an extension of, IBFD's: */
      if (mips_mach_extends_p(bfd_get_mach(obfd), bfd_get_mach(ibfd)))
	{
	  ...
	  if (((old_flags & EF_MIPS_ABI) == 0)
	      ...
	      && !mips_32bit_flags_p(new_flags & (flagword)~EF_MIPS_ABI))
  ...
  if ((new_flags & EF_MIPS_ABI) != (old_flags & EF_MIPS_ABI)
	      ...
	      != elf_elfheader(obfd)->e_ident[EI_CLASS]))
	{
      ...
      new_flags &= (flagword)~EF_MIPS_ABI;
      old_flags &= (flagword)~EF_MIPS_ABI;
    }
  ...
  if ((new_flags & EF_MIPS_ARCH_ASE) != (old_flags & EF_MIPS_ARCH_ASE))
    {
      ...
      new_flags &= (flagword)~EF_MIPS_ARCH_ASE;
      old_flags &= (flagword)~EF_MIPS_ARCH_ASE;
    }
...
#ifdef CRF_MIPS_SHORT
# undef CRF_MIPS_SHORT
#endif /* CRF_MIPS_SHORT */
#ifdef CRT_MIPS_GPHI_LO
# undef CRT_MIPS_GPHI_LO
#endif /* CRT_MIPS_GPHI_LO */
#ifdef CRT_MIPS_JMPAD
# undef CRT_MIPS_JMPAD
#endif /* CRT_MIPS_JMPAD */
#ifdef cbRPDR
# undef cbRPD
#endif /* cbRPDR */
...
# undef MNAME
#endif /* MNAME */
#ifdef MIPS_ELF_GET_WORD
# undef MIPS_ELF_GET_WORD
#endif /* MIPS_ELF_GET_WORD */
