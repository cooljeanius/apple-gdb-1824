...
static int
ImgPhotoSetSize (PhotoMaster *masterPtr, int width, int height)
{
...
DitherInstance (
    ...
    int xStart,
    int yStart,		/* Coordinates of the top-left pixel in the
				 * block to be dithered. */
    int width,
    int height		/* Dimensions of the block to be dithered. */
)
{
    PhotoMaster *masterPtr;
    ColorTable *colorPtr;
