/* mipsm3-nat.c: Definitions to make GDB run on a mips box under Mach 3.0
...
#ifndef LO_REGNUM
# define LO_REGNUM MIPS_EMBED_LO_REGNUM
#endif /* !LO_REGNUM */
#ifndef HI_REGNUM
# define HI_REGNUM MIPS_EMBED_HI_REGNUM
#endif /* !HI_REGNUM */
#ifndef FCRCS_REGNUM
# define FCRCS_REGNUM MIPS_UNUSED_REGNUM /* FIXME */
#endif /* !FCRCS_REGNUM */
...
/* FIXME: where is this actually supposed to be? */
...
store_inferior_registers (register int regno)
{
  ...
  if (regno == -1 || regno >= FP0_REGNUM)
	...
	message("Thread does not use floating point unit, floating regs not saved");
    }
}
