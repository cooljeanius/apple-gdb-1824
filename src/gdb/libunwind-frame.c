...
#else
# warning libunwind-frame.c expects "config.h" to be included.
#endif /* HAVE_CONFIG_H */

#ifdef HAVE_DLFCN_H
# include <dlfcn.h>
#else
# warning libunwind-frame.c expects <dlfcn.h> to be included.
#endif /* HAVE_DLFCN_H */

#ifdef HAVE_LIBUNWIND_H
# include <libunwind.h>
#else
# warning libunwind-frame.c expects <libunwind.h> to be included.
...
libunwind_frame_cache (struct frame_info *next_frame, void **this_cache)
{
  ...
  if (ret < 0)
    error (_("Cannot get libunwind sp register."));
