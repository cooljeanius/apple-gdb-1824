...
- (id)initWithAddress:(id)arg1 format:(int)arg2 bytesPerWord:(unsigned long long)arg3 rows:(unsigned long long)arg4 columns:(unsigned long long)arg5 viewerIdentifier:(id)arg6;
- (void)dealloc;
