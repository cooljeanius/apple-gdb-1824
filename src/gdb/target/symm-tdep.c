/* symm-tdep.c: Sequent Symmetry target interface, for GDB.
...
extern void symmetry_extract_return_value(struct type *, char *, char *);
      ...
      if (msymbol != NULL)
	{
	  ...
	  switch (TYPE_LENGTH(type))
	    ...
	    case 8:
	      ...
	      break;
	    default:
	      error(_("Unknown floating point size"));
	      break;
	    }
	}
      else
