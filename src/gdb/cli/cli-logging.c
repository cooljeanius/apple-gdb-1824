...
extern void _initialize_cli_logging(void);
...
/* If we have pushed output files, then close them and pop them: */
static void
pop_output_files(void)
{
  ...
  /* APPLE LOCAL:  Do NOT delete (free) gdb_stdout if it is/has the same
   * value as saved_output.out: */
