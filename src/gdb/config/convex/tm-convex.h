...
*/
extern CORE_ADDR convex_skip_prologue  (CORE_ADDR pc);
...
#define S0_REGNUM 25                /* the real S regs */#define S7_REGNUM 18
#define s0_REGNUM 17                /* low-order halves of S regs */#define s7_REGNUM 10
#define SP_REGNUM 9                 /* A regs */#define A1_REGNUM 8
#define A5_REGNUM 4
#define AP_REGNUM 3
#define FP_REGNUM 2         /* Contains address of executing stack frame */#define PS_REGNUM 1         /* Contains processor status */#define PC_REGNUM 0         /* Contains program counter */
...
/* Total amount of space needed to store our copies of the machine's
   register state, the array `registers'.  */#define REGISTER_BYTES (4*10 + 8*8)
...
/* For the native compiler, variables for a particular lexical context
   ...
   desc is nonzero for native, zero for gcc.   */#define VARIABLES_INSIDE_BLOCK(desc, gcc_p) (desc != 0)

/* Pcc occaisionally puts an SO where there should be an SOL.   */#define PCC_SOL_BROKEN

...
/* An expression that tells us whether the function invocation represented
   ...
   otherwise, not.  */
extern int convex_frameless_function_invocation  (struct frame_info *fi);
...
extern int convex_frame_num_args  (struct frame_info *fi);
