/* tm-i386mk.h: Macro definitions for i386, Mach 3.0, OSF 1/MK
 ...
 * to `double'.  However, I am not sure what is the consequence of:
 *
 * #define TARGET_LONG_DOUBLE_FORMAT TARGET_DOUBLE_FORMAT
 * #define TARGET_LONG_DOUBLE_BIT TARGET_DOUBLE_BIT
 *
 * So I will go with the current status quo instead.  It looks like this
 * target fails to compile anyway. Perhaps it should be re-obsoleted? */
