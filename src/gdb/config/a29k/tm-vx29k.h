...
/* For the basic CALL_DUMMY definitions, see "tm-29k.h."  We use the
   ...
   CALL_DUMMY code fragment; under VxWorks, we cannot simply insert a
...
/* The offset of the first instruction of the CALL_DUMMY code fragment
   ...
   in "tm-29k.h").  */
/* PAD : the arg_slop area size does NOT appear to me to be useful since, the
...
/* Insert the specified number of args and function address
   ...
   We cannot keep using a CALL_DUMMY that modify the msp since, for VxWorks,
...
#endif /* TARGET_BYTE_ORDER == BFD_ENDIAN_BIG */
