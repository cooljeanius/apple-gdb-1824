...
do_target_signal_to_host(enum target_signal oursig,
			 int *oursig_ok)
{
  /* keep this condition the same as where the variable is used: */
#if defined(REALTIME_LO)
  int retsig;
#endif /* REALTIME_LO */
...
# endif /* SIGCHLD */
	...
	{
	  /* TARGET_SIGNAL_REALTIME_32 is NOT contiguous with
