...
/* APPLE LOCAL huh? */
extern void convert_sal(struct symtab_and_line *sal);

extern void add_one_pathname_substitution(const char *old, const char *);

extern int open_source_file_fullpath(const char *, const char *, char **);
