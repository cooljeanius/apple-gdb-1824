...
extern PTR mmalloc_findbase_hidden PARAMS((size_t));
extern void mmalloc_endpoints PARAMS((PTR, size_t *, size_t *));

extern void mmalloc_set_default_allocator PARAMS((PTR));
extern PTR mmalloc_default_allocator PARAMS((void));

extern struct mdesc * mmalloc_malloc_create PARAMS((void));
extern struct mdesc * mmalloc_pagecheck_create PARAMS((void));
