		...
		<GuiGdbManagerExecLock, GuiGdbManagerInternal>
{
    ...
    /* held when executing a cmd -- not currently used */
    NSLock				*execLock;

    /* true if we have just entered the command loop */
    ...
    /* used when debuggercontroller wants to know gdb is done w/all commands */
