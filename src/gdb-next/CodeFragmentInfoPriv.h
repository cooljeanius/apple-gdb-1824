...
/*
   ----------------------------------------------------------------------------
   Notification clients get told about the CFM events they are interested in.
   There are four classes of notifications relating to kernel processes,
   closures, init/term routines, and other stuff. In each case relevant
   informational routines are callable, e.g. the process information can be
   obtained from CFragGetProcessInfo at both the process start and finish
...
/*
   ----------------------------------------------------------------------------
   Different kinds of notification provide different (specific) information
   about the event.
*/
...
enum {
  ...
  kTermPendingCFragState        = -1,   /* Termination in progress, do NOT share anymore. */
