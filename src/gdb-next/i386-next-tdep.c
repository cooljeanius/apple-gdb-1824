/* i386-next-tdep.c: Intel 386 target-dependent stuff.
...
i386_next_fetch_gp_registers(unsigned char *rdata ATTRIBUTE_UNUSED,
			     gdb_i386_thread_state_t *gp_regs ATTRIBUTE_UNUSED)
{
  return;
}
...
/* */
void ATTRIBUTE_CONST
i386_next_store_gp_registers(unsigned char *rdata ATTRIBUTE_UNUSED,
			     gdb_i386_thread_state_t *gp_regs ATTRIBUTE_UNUSED)
{
  return;
}
...
/* */
void
i386_next_fetch_sp_registers(unsigned char *rdata,
			     gdb_i386_thread_state_t *sp_regs)
{
...
/* */
void
i386_next_store_sp_registers(unsigned char *rdata,
			     gdb_i386_thread_state_t *sp_regs)
{
  /* these need to match the REGISTER_NAMES table from tm-i386.h */
...
/* */
void ATTRIBUTE_CONST
i386_next_fetch_fp_registers(unsigned char *rdata ATTRIBUTE_UNUSED,
			     gdb_i386_thread_fpstate_t *fpregs ATTRIBUTE_UNUSED)
{
  return;
}
...
/* */
void ATTRIBUTE_CONST
i386_next_store_fp_registers(unsigned char *rdata ATTRIBUTE_UNUSED,
			     gdb_i386_thread_fpstate_t *fpregs ATTRIBUTE_UNUSED)
{
  return;
}
...
CORE_ADDR
i386_next_skip_trampoline_code(CORE_ADDR pc)
{
...
/* */
int
i386_next_in_solib_call_trampoline(CORE_ADDR pc, char *name)
{
...
sigtramp_saved_pc(struct frame_info *frame ATTRIBUTE_UNUSED)
{
  return 0;
}
