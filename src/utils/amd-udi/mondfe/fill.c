...
# include "config.h"
#else
# warning fill.c expects "config.h" to be included.
#endif /* HAVE_CONFIG_H */
#include <stdio.h>
#include <string.h>
#include <ctype.h>
...
#  else
#   warning fill.c expects a malloc-related header to be included.
...
fill_cmd(token, token_count)
   ...
   */
   ...
   /*
   ** We do NOT set bytes or half words in registers
   */
