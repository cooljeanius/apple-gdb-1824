...
# include "config.h"
#else
# warning tdfunc.c expects "config.h" to be included.
#endif /* HAVE_CONFIG_H */
#include <stdio.h>
#include <string.h>
...
#     include <term.h>
#    else
#     warning tdfunc.c expects a header that provides termios-related functions to be included.
#    endif /* HAVE_TERM_H */
#   endif /* HAVE_SGTTY_H */
...
#  include <sys/ioctl.h>
# else
#  warning tdfunc.c expects <sys/ioctl.h> to be included.
...
#else
	/* assume termios */
   struct termios	OrigTBuf, NewTBuf;
#endif /* HAVE_TERMIOS_H */
