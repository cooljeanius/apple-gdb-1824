...
# include "config.h"
#else
# warning udi2mtip.c expects "config.h" to be included.
#endif /* HAVE_CONFIG_H */
#include <stdio.h>
#include <signal.h>
...
#   else
#    warning udi2mtip.c expects a header that provides malloc() to be included.
...
#ifndef TIP_IO_BUFSIZE
# define	TIP_IO_BUFSIZE		1024
#endif /* !TIP_IO_BUFSIZE */
#ifdef _UDIPROC_H
...
static char    *monerr_tip[] = {
   ...
   /* 25 */ "Could NOT get target config after reset. Try again.",
...
#ifdef _UDIPROC_H /* (whole function) */
UDIError 
  ...
  UDISizeT         *count_done;
{
  ...
  /*
   * ASSUMPTION: It is always a non-blocking read & this function is called
