...
# include "config.h"
#else
# warning lcb29k.c expects "config.h" to be included.
#endif /* HAVE_CONFIG_H */
#include <stdio.h>
#include <stdlib.h>
#include <memory.h>
...
msg_recv_lcb29k(msg_ptr, PC_port_base, Mode)
   ...
   if ((control_reg & LCB29K_INTPC) != 0) {
     /* Clear LCB29K_INTPC (and do NOT interrupt 29K) */
   ...
   /* If no message waiting, return -1 (This should NOT happen) */
