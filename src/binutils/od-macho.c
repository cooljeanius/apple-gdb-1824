...
# if !defined(BFD_MACH_O_MH_KEXT_BUNDLE)
#  if 0
...
#  endif /* 0 */
# endif /* !BFD_MACH_O_MH_KEXT_BUNDLE */
# if !defined(_MACH_O_LOADER_H) && \
     (defined(HAVE_MACH_I386_THREAD_STATUS_H) || \
      (defined(__APPLE_CC__) && \
       (defined(__i386) || defined(__i386__) || defined(__x86_64__))))
#  include <mach/i386/thread_status.h>
# else
#  if defined(__GNUC__) && !defined(__STRICT_ANSI__) && !defined(_MACH_O_LOADER_H)
#   warning "We need some mach thread status definitions somehow..."
#  endif /* __GNUC__ && !__STRICT_ANSI__ && !_MACH_O_LOADER_H */
# endif /* !_MACH_O_LOADER_H && (HAVE_MACH_I386_THREAD_STATUS_H || __i386__) */
#else
...
#if !defined(_MACH_O_LOADER_H)
# if !defined(BFD_MACH_O_x86_THREAD_STATE32)
#  if defined(x86_THREAD_STATE32)
#   define BFD_MACH_O_x86_THREAD_STATE32 x86_THREAD_STATE32
#  else
#   define BFD_MACH_O_x86_THREAD_STATE32 1
#  endif /* x86_THREAD_STATE32 */
# endif /* !BFD_MACH_O_x86_THREAD_STATE32 */
# if !defined(BFD_MACH_O_x86_FLOAT_STATE32)
#  if defined(x86_FLOAT_STATE32)
#   define BFD_MACH_O_x86_FLOAT_STATE32 x86_FLOAT_STATE32
#  else
#   define BFD_MACH_O_x86_FLOAT_STATE32 2
#  endif /* x86_FLOAT_STATE32 */
# endif /* !BFD_MACH_O_x86_FLOAT_STATE32 */
# if !defined(BFD_MACH_O_x86_EXCEPTION_STATE32)
#  if defined(x86_EXCEPTION_STATE32)
#   define BFD_MACH_O_x86_EXCEPTION_STATE32 x86_EXCEPTION_STATE32
#  else
#   define BFD_MACH_O_x86_EXCEPTION_STATE32 3
#  endif /* x86_EXCEPTION_STATE32 */
# endif /* !BFD_MACH_O_x86_EXCEPTION_STATE32 */
# if !defined(BFD_MACH_O_x86_DEBUG_STATE32)
#  if defined(x86_DEBUG_STATE32)
#   define BFD_MACH_O_x86_DEBUG_STATE32 x86_DEBUG_STATE32
#  else
#   define BFD_MACH_O_x86_DEBUG_STATE32 10
#  endif /* x86_DEBUG_STATE32 */
# endif /* !BFD_MACH_O_DEBUG_STATE32 */
# if !defined(BFD_MACH_O_x86_DEBUG_STATE64)
#  if defined(x86_DEBUG_STATE64)
#   define BFD_MACH_O_x86_DEBUG_STATE64 x86_DEBUG_STATE64
#  else
#   define BFD_MACH_O_x86_DEBUG_STATE64 11
#  endif /* x86_DEBUG_STATE64 */
# endif /* !BFD_MACH_O_DEBUG_STATE64 */
# if !defined(BFD_MACH_O_x86_DEBUG_STATE)
#  if defined(x86_DEBUG_STATE)
#   define BFD_MACH_O_x86_DEBUG_STATE x86_DEBUG_STATE
#  else
#   define BFD_MACH_O_x86_DEBUG_STATE 12
#  endif /* x86_DEBUG_STATE */
# endif /* !BFD_MACH_O_DEBUG_STATE */
# if !defined(BFD_MACH_O_x86_THREAD_STATE_NONE)
#  if defined(THREAD_STATE_NONE)
#   define BFD_MACH_O_x86_THREAD_STATE_NONE THREAD_STATE_NONE
#  else
#   define BFD_MACH_O_x86_THREAD_STATE_NONE 13
#  endif /* THREAD_STATE_NONE */
# endif /* !BFD_MACH_O_x86_THREAD_STATE_NONE */
#else
# if defined(__GNUC__) && !defined(__STRICT_ANSI__) && \
     !defined(_ENUM_BFD_MACH_O_I386_THREAD_FLAVOUR_DEFINED)
#  warning "No really, we need those mach thread status definitions."
# endif /* __GNUC__ && !__STRICT_ANSI__ && !_ENUM_BFD_MACH_O_I386_THREAD_FLAVOUR_DEFINED */
...
#if defined(BFD_MACH_O_MH_KEXT_BUNDLE) || defined(_ENUM_BFD_MACH_O_FILETYPE_DEFINED)
  { "kext_bundle", BFD_MACH_O_MH_KEXT_BUNDLE },
#endif /* BFD_MACH_O_MH_KEXT_BUNDLE || _ENUM_BFD_MACH_O_FILETYPE_DEFINED */
  { NULL, 0 }
};
...
dump_dysymtab(bfd *abfd, bfd_mach_o_load_command *cmd, bfd_boolean verbose)
{
  ...
  if ((dysymtab->ntoc > 0) || (dysymtab->nindirectsyms > 0)
  ...
  for (j = 0; j < thread->nflavours; j++)
    {
      ...
      if (bed->_bfd_mach_o_print_thread)
        {
          char *buf = (char *)xmalloc(flavour->size);
...
static unsigned int
dump_code_signature_blob(bfd *abfd, const unsigned char *buf,
                         unsigned int len);
...
{
  unsigned char *buf = (unsigned char *)xmalloc(cmd->datasize);
  unsigned int off;
  ...
  for (off = 0; off < cmd->datasize;)
    {
      ...
      len = dump_code_signature_blob(abfd, (buf + off),
                                     (cmd->datasize - off));
                  ...
                  bfd_boolean verbose)
{
  ...
  cmd_name = bfd_mach_o_get_name_or_null(bfd_mach_o_load_command_name,
                                         cmd->type);
  printf("Load command ");
  if (cmd_name == NULL) {
...
mach_o_dump(bfd *abfd)
{
  ...
  if (options[OPT_SECTION].selected) {
    dump_load_commands(abfd, BFD_MACH_O_LC_SEGMENT,
