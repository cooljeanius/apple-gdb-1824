 ...
 * I have talked with Srikanth <srikanth@cup.hp.com>, and he assures me
 * this is right, but I still strongly suspect that there is a
 * misunderstanding here.
 *
 * If we decide that it is better for c++filt to use HP's assembler syntax
 * to scrape identifiers out of its input, here is the definition of
