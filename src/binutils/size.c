...
main(int argc, char **argv)
{
  ...
  if (show_totals && berkeley_format)
    {
      bfd_size_type total;
      total = (total_textsize + total_datasize + total_bsssize);
...
/* (why though?) */
extern bfd_size_type svi_total;
bfd_size_type svi_total = 0;
extern bfd_vma svi_maxvma;
bfd_vma svi_maxvma = 0;
extern size_t svi_namelen;
size_t svi_namelen = 0;
extern size_t svi_vmalen;
size_t svi_vmalen = 0;
extern size_t svi_sizelen;
