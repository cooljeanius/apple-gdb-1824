# Sed commands to finish translating the binutils Unix makefile into
# MPW syntax.
...
# Do NOT build specialized tools.
...
# Do NOT try to make the demangler's man page, it is useless.
/^{DEMANGLER_PROG}\.1 \\Option-f/,/^$/d
# Do NOT depend on it either.
