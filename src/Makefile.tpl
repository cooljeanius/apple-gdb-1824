...
local-distclean:
	-rm -f Makefile Makefile*orig src_am/Makefile config.h
	...
	-if test -d texinfo/js && test -w texinfo/js && test -r texinfo/js/Makefile && test -s texinfo/js/Makefile; then \
	  ...
	  elif test -f texinfo/js/Makefile && test "x${enable_werror}" != "xyes"; then \
	    touch am--refresh && touch texinfo/js/Makefile; \
	    $(MAKE) -C texinfo/js -ki $(AM_V_MFLAG) $(FLAGS_TO_PASS) distclean; \
