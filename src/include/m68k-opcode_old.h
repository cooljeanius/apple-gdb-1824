...
/* JF: for the 68851 */
/*
   I did NOT use much imagination in choosing the
   following codes, so many of them are NOT very
   mnemonic. -rab
...
/*
   ...
   consecutive.  If they are NOT, the assembler will bomb at runtime.
 */
