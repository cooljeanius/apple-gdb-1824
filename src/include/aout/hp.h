/* hp.h: Special version of <a.out.h> for use under hp-ux.
...
/* Header guard to allow this file to be included twice: */
...
/* Tell a.out.gnu.h not to define `struct exec' by defining this instead: */
