/* spin.h: Progress macros that use SpinCursor in MPW.
...
/* In order to determine if we are meeting the goal, define this macro
 * and info about frequency of spinning will be collected and displayed: */
#define SPIN_MEASUREMENT 1

#include <CursorCtl.h>

/* Programs use this macro to indicate the start of a lengthy activity.
 * STR identifies the particular activity, while N indicates
 * the expected duration, in unspecified units. If N is zero,
 * then the expected time to completion is unknown. */
