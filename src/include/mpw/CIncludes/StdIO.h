/************************************************************
	...
	Copyright (c) Apple Computer,Inc.  1985-1991.
 ...
 *	form tmp.AAAXXXXXX, where AAA is a sequence of lower case letters
 *	("aaa", "baa", ... "zzz" on successive calls), and XXXXXX is a lower case
 *	letter followed by a sequence of digits, all determined at runtime.
