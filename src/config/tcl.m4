...
AC_DEFUN([SC_LOAD_TCLCONFIG],[
	...
	. ${TCL_BIN_DIR}/tclConfig.sh
        ...
        AC_MSG_RESULT([could not find an existing ${TCL_BIN_DIR}/tclConfig.sh])
    fi
...
AC_DEFUN([SC_TCL_GETHOSTBYADDR_R],[
    ...
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETHOSTBYADDR_R_7],[7],[Define to 7 for a gethostbyaddr_r with 7 args])
    else
	...
	if test "${tcl_ok}" = yes; then
	    AC_DEFINE([HAVE_GETHOSTBYADDR_R_8],[8],[Define to 8 for a gethostbyaddr_r with 8 args])
	fi
    fi
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETHOSTBYADDR_R],[1],[Define to 1 if we have the gethostbyaddr_r function])
    fi
    ])
])
...
AC_DEFUN([SC_TCL_GETHOSTBYNAME_R],[
    ...
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETHOSTBYNAME_R_6],[6],[Define to 6 for a gethostbyname_r with 6 args])
    else
	...
	if test "${tcl_ok}" = yes; then
	    AC_DEFINE([HAVE_GETHOSTBYNAME_R_5],[5],[Define to 5 for a gethostbyname_r with 5 args])
	else
	    ...
	    if test "${tcl_ok}" = yes; then
		AC_DEFINE([HAVE_GETHOSTBYNAME_R_3],[3],[Define to 3 for a gethostbyname_r with 3 args])
	    fi
	fi
    fi
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETHOSTBYNAME_R],[1],[Define to 1 if we have the gethostbyname_r function])
    fi
    ])
])
...
AC_DEFUN([SC_TCL_GETPWUID_R],[
    ...
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETPWUID_R_5],[5],[Define to 5 for a getpwuid_r with 5 args])
    else
	...
	if test "${tcl_ok}" = yes; then
	    AC_DEFINE([HAVE_GETPWUID_R_4],[4],[Define to 4 for a getpwuid_r with 4 args])
	fi
    fi
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETPWUID_R],[1],[Define to 1 if we have the getpwuid_r function])
    fi
    ])
])
...
AC_DEFUN([SC_TCL_GETPWNAM_R],[
    ...
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETPWNAM_R_5],[5],[Define to 5 for a getpwnam_r with 5 args])
    else
	...
	if test "${tcl_ok}" = yes; then
	    AC_DEFINE([HAVE_GETPWNAM_R_4],[4],[Define to 4 for a getpwnam_r with 4 args])
	fi
    fi
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETPWNAM_R],[1],[Define to 1 if we have the getpwnam_r function])
    fi
    ])
])
...
AC_DEFUN([SC_TCL_GETGRGID_R],[
    ...
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETGRGID_R_5],[5],[Define to 5 for a getgrgid_r with 5 args])
    else
	...
	if test "${tcl_ok}" = yes; then
	    AC_DEFINE([HAVE_GETGRGID_R_4],[4],[Define to 4 for a getgrgid_r with 4 args])
	fi
    fi
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETGRGID_R],[1],[Define to 1 if we have the getgrgid_r function])
    fi
])])
...
AC_DEFUN([SC_TCL_GETGRNAM_R],[
    ...
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETGRNAM_R_5],[1],[Define to 1 for a getgrnam_r with 5 args])
    else
	...
	if test "${tcl_ok}" = yes; then
	    AC_DEFINE([HAVE_GETGRNAM_R_4],[1],[Define to 1 for a getgrnam_r with 5 args])
	fi
    fi
    if test "${tcl_ok}" = yes; then
	AC_DEFINE([HAVE_GETGRNAM_R],[1],[Define to 1 if we have the getgrnam_r function])
    fi
    ])
])
