...
dnl# but do NOT support all of the features we need from it.
dnl#
...
if test "$gcc_header_sys_mman_h" != yes \
 || test "$gcc_func_mmap" != yes; then
  ...
  [# Add a system to this blacklist if 
   # mmap(0, stat_size, PROT_READ, MAP_PRIVATE, fd, 0) does NOT return a
...
[int n = MAP_ANONYMOUS;])],
  ...
  [# Add a system to this blacklist if it has mmap() and MAP_ANON or
   ...
   # does NOT give anonymous zeroed pages with the same properties listed
