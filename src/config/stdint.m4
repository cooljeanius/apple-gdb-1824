...
dnl# in other environments it will provide the basic 'stdint's defined:
dnl# int8_t,uint8_t,int16_t,uint16_t,int32_t,uint32_t,intptr_t,uintptr_t
dnl# int_least32_t.. int_fast32_t.. intmax_t
dnl# which may or may not rely on the definitions of other files.
dnl#
dnl# Sometimes the stdint.h or inttypes.h headers clash with sys/types.h,
dnl# so we test the headers together with sys/types.h and always include it
dnl# in the generated header (to match the tests with the generated file).
dnl# Hopefully this is not a big annoyance.
dnl#
dnl# If your installed headers require the stdint-types you will want to
...
dnl# file will include it directly. No need for HAVE_STDINT_H things...
dnl#
