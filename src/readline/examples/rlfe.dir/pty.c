...
/* SVR4 pseudo ttys do NOT seem to work with SCO-5 */
#ifdef M_UNIX
...
#  endif /* M_UNIX */
# endif /* hpux */
#endif /* !(sequent || _SEQUENT_ || HAVE_SVR4_PTYS) */
...
# endif /* sun */
#endif /* I_PUSH && HAVE_SVR4_PTYS && !sgi && !linux && !__osf__ && !M_UNIX */
}
...
#endif /* (sequent || _SEQUENT_) && !PTY_DONE */
...
#endif /* MIPS && HAVE_DEV_PTC && !PTY_DONE */
...
#endif /* _AIX && HAVE_DEV_PTC && !PTY_DONE */
