...
/* 41 */
EXTERN const char*	Itcl_GetCommonVar _ANSI_ARGS_((Tcl_Interp * interp,
...
EXTERN int		Itcl_HandleInstance _ANSI_ARGS_((
				...
				int objc, Tcl_Obj *CONST objv[]));
/* 48 */
EXTERN const char*	Itcl_GetInstanceVar _ANSI_ARGS_((Tcl_Interp * interp,
...
/* 63 */
EXTERN CompiledLocal*	Itcl_CreateArg _ANSI_ARGS_((const char * name,
				const char * init));
/* 64 */
...
typedef struct ItclIntStubs {
    ...
    int (*itcl_CreateVarDefn) _ANSI_ARGS_((Tcl_Interp * interp, ItclClass* cdefn, const char * name, const char * init, const char * config, ItclVarDefn** vdefnPtr)); /* 39 */
    ...
    int (*itcl_CreateMemberCode) _ANSI_ARGS_((Tcl_Interp* interp, ItclClass * cdefn, char* arglist, const char * body, ItclMemberCode** mcodePtr)); /* 57 */
