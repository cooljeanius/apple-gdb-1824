...
/* since it is possible that the caller may include tcl.h before including
   this file, we cannot include varargs/stdargs ourselves */

/* Much of the following stdarg/prototype support is taken from tcl.h
 * (7.5) with modifications. What is going on here is that we do NOT want
...
#    include <varargs.h>
#   else
#    warning expect_comm.h expects <varargs.h> to be included.
...
#  define _TCL
# endif /* _TCL */
#endif /* EXP_AVOID_INCLUDING_TCL_H */
...
EXTERN int exp_disconnected;		/* proc. discarded from controlling tty */
