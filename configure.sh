...
# Generated by GNU Autoconf 2.69 for apple-gdb 1824.
#
...
exit 255
  ...
  if test x${ZSH_VERSION+set} = xset ; then
    ...
    $as_echo "$0: Please tell bug-autoconf@gnu.org and jmolenda@apple.com
...
$as_echo "$as_me: WARNING: $2: proceeding with the compiler's result" >&2;}
( $as_echo "## --------------------------------- ##
## Report this to jmolenda@apple.com ##
## --------------------------------- ##"
...
if test -x "`which sw_vers 2>/dev/null`"; then
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking automake things" >&5
$as_echo_n "checking automake things... " >&6; }
...
# Checks for programs.
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking programs" >&5
$as_echo_n "checking programs... " >&6; }
{ $as_echo "$as_me:${as_lineno-$LINENO}: result:  " >&5
$as_echo " " >&6; }
ac_ext=c
ac_cpp='$CPP $CPPFLAGS'
...
if test "x${AWK}" = "x" && test "x${ac_cv_prog_AWK}" = "x"; then :
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_BUILDIT+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $BUILDIT in
  [\\/]* | ?:[\\/]*)
...
if test -n "$BUILDIT"; then
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $BUILDIT" >&5
$as_echo "$BUILDIT" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_iberty_main" >&5
$as_echo "$ac_cv_lib_iberty_main" >&6; }
if test "x$ac_cv_lib_iberty_main" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_LIBIBERTY 1
_ACEOF
...
if test "x$ac_cv_lib_intl_main" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_LIBINTL 1
_ACEOF
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking C compiler charactersistics" >&5
$as_echo_n "checking C compiler charactersistics... " >&6; }
{ $as_echo "$as_me:${as_lineno-$LINENO}: result:  " >&5
$as_echo " " >&6; }
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking types" >&5
$as_echo_n "checking types... " >&6; }
{ $as_echo "$as_me:${as_lineno-$LINENO}: result:  " >&5
$as_echo " " >&6; }
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking functions" >&5
$as_echo_n "checking functions... " >&6; }
{ $as_echo "$as_me:${as_lineno-$LINENO}: result:  " >&5
$as_echo " " >&6; }
